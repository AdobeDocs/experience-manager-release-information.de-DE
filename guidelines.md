...
Adobe Experience Manager-Benutzende arbeiten in extrem wettbewerbsorientierten Umgebungen, um digitale Erlebnisse zu erstellen, die sie von ihren Wettbewerbern abheben. Wenn Adobe fortschrittliche neue Tools in AEM einführt, bieten sie daher eine genaue und klare Dokumentation. Dieser Ansatz ermöglicht es Kunden, ihre AEM-Investitionen sofort zu nutzen und den ROI zu maximieren.

Das Ziel der AEM-Dokumentation besteht darin, AEM-Benutzende schnellstmöglich mit der Dokumentation vertraut zu machen. Daher wird eine genaue, nutzbare Dokumentation erstellt und laufend aktualisiert und verbessert.

## Beiträge zur Dokumentation

Zur stetigen Verbesserung der AEM-Dokumentation ist die gesamte Community von AEM-Benutzern herzlich eingeladen, zur Dokumentation beizutragen. Sei es durch Pull-Anfragen oder -Probleme, Verbesserungen an der Dokumentation können Korrekturen, Klarstellungen, Erweiterungen und mehr Beispiele sein.

## Dokumentationsstandards

Adobe begrüßt Beiträge zu der Dokumentation. Jeder Beitrag zur AEM-Dokumentation, ob eine Pull-Anfrage oder ein Problem, muss den Adobe-Beitrags- und Dokumentationsstandards entsprechen.
...
Wenn Sie das Produkt zum ersten Mal in einem Artikel erwähnen, verwenden Sie immer seinen vollständigen Namen **Adobe Experience Manager**. Danach können Sie sie als **AEM** bezeichnen.

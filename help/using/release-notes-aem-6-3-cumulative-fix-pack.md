...
AEM Cumulative Fix Pack 6.3.3.8 ist abhängig von AEM 6.3 Service Pack 3. Daher müssen Sie das AEM Cumulative Fix Pack 6.3.3.x-Paket nach der Installation von AEM 6.3 Service Pack 3 installieren. Installationsanweisungen finden Sie in den Versionshinweisen für [AEM 6.3 Service Pack 3](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions).
...
* Der Inhalt einer Komponente wird in der -Autoreninstanz geändert und dann aktiviert, ist in der Publish-Instanz nicht sichtbar, bis die Komponente neu gestartet wird **com.day.cq.personalization.impl.TargetedContentManagerImpl** (NPR-32489 und NPR-32232).
...
>[!NOTE]
>
>AEM Forms-Add-on-Pakete helfen, die Formularfunktionalität mit AEM Service Packs und Cumulative Fix Packs abzustimmen. Daher ist es unbedingt erforderlich, das AEM Forms Add-On-Paket nach der Installation von AEM Service Pack, Cumulative Fix Pack oder Feature Pack zu installieren.
...
* Assets ausgewählt (in der Spaltenansicht in der Touch-optimierten Benutzeroberfläche), bevor die Filteroption aus der Dropdown-Liste Nur Inhalt ausgewählt und dann die Option Verschieben ausgewählt wird, wird ebenfalls verschoben (NPR-30693).
...
* Wenn ein Benutzer eine Seite veröffentlicht, zeigt das Dialogfeld für die Rollout-Konfiguration doppelte Live Copy-Pfade an (NPR-30438).
...
* Ein Benutzer konzentriert sich auf die Felder in der linken Leiste und verwendet einen Tastaturbefehl zum Einfügen von Inhalten. Dadurch wird der Inhalt der Zwischenablage des Seiteneditors anstelle des Inhalts eingefügt, der aus den Feldern der linken Leiste kopiert wurde (NPR-31173).
...
* Die Videoaggregation nach Dynamic Video gibt nur die 100 wichtigsten Elemente in der Ergebnismenge zurück. NPR-30441: Hotfix für CQ-4213561
* Problem bei der Verbindung mit Adobe Smart-Tag über DataPower. NPR-30026: Hotfix für CQ-4269457
* Das Dekomprimieren eines Archivs mit einem Ordner mit einem Prozentzeichen (%) im Namen kann nicht über die Assets-Benutzeroberfläche geöffnet werden. NPR-29989: Hotfix für CQ-4270467
...
* Beim Generieren eines CSV-Exports wird der Bericht durch das Hinzufügen benutzerdefinierter Spalten für die Listenansicht beschädigt. NPR-30208: Hotfix für CQ-4273344
* OOTB-Berichte in /etc/reports/ funktionieren nicht ordnungsgemäß und das historische Datendiagramm wird nicht angezeigt. NPR-30016: Hotfix für CQ-4220180
* Der Wert des Anforderungsparameters resourceType wird in den Wert eines HTML-Tag-Attributs kopiert, das in doppelte Anführungszeichen eingeschlossen ist. NPR-29832: Hotfix für CQ-4255365

### Communities {#communities-1}

* Problem mit doppelten Inhalten mit der AEM Communities-Moderationskonsole. NPR-30667: Hotfix für CQ-4276829
...
* Wenn beim HTML-to-PDF-Dienst ein Belastungstest durchgeführt wird, schlägt er mit einem Fehler fehl und die Dateitypeinstellungen werden vom AEM Forms-Server entfernt. NPR-30111, NPR-30086: Hotfix für CQ-4271495
...
AEM Cumulative Fix Pack 6.3.3.5 ist abhängig von AEM 6.3 Service Pack 3. Daher müssen Sie das AEM Cumulative Fix Pack 6.3.3.x-Paket nach der Installation von AEM 6.3 Service Pack 3 installieren. Installationsanweisungen finden Sie in den Versionshinweisen für [AEM 6.3 Service Pack 3](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions).
...
* Eine Bildausgabe für ein Video-Asset kann nicht von der Seite Asset-Details gelöscht werden. NPR-29417: Hotfix für CQ-4268675
...
* CoralUI speichert bei Verwendung mit Multifield den fileReferenceParameter auf Komponentenebene und nicht auf Multifield-Ebene. NPR-29535: Hotfix für CQ-4266129
...
* Das Pfadfeld wird unabhängig vom Pfad, der für die Suche angegeben ist, im Stammpfad geöffnet. NPR-29398: Hotfix für CQ-4268897
...
* Leere Eigenschaften und mehrere Eigenschaften werden während des Rollouts nicht aus dem Blueprint übernommen. Das Zurücksetzen der Live Copy auf den Blueprint-Status funktioniert nicht für Komponenten. NPR-29252: Hotfix für CQ-4264928, CQ-4264926, CQ-4267722
...
* Sie können Experience Fragments nicht in Target exportieren, wenn ein Smart-Bild verwendet wird. Hotfix für CQ-4269606

### Replikation {#replication}

* Die Replikationsagenten-Komponente ist anfällig für eine Sicherheitslücke, durch die vertrauliche Informationen für nicht autorisierte Benutzer offen gelegt werden. NPR-29613: Hotfix für Granite-25070
* Vom Benutzer bereitgestellte Daten werden bei der Ausgabe in der Komponente `cq/replication/components/agent`nicht maskiert, was zu einer Sicherheitslücke beim gespeicherten Cross-Site Scripting (XSS) führt. NPR-29452: Hotfix für CQ-4266263
...
* Workflow CommandLineProcess schlägt mit einem Dateinamen mit einem einfachen Anführungszeichen fehl. NPR-28805: Hotfix für CQ-4262287
* Die Werte unterscheiden sich bei Verwendung des Filters zwischen der Sammlungsseite und der Sammlungsseite. NPR-28642: Hotfix für CQ-4261405
...
* Bilddarstellungen eines Video-Assets können nicht von der Asset-Detailseite gelöscht werden. NPR-29149: Hotfix für CQ-4266073
...
* Die Datei &quot;`coral.js`&quot; enthält eine verwundbare Version der Bibliothek &quot;`handlebars.js`&quot;. NPR-26973: Hotfix für CQ-4255377
* Wenn Sie eine Target-Komponente mit einem verschachtelten Layout-Container und einer Textkomponente verwenden, wird beim Bearbeiten von Text oder Klicken auf den Container der JavaScript-Fehler &quot;Cannot read property currentPos of null&quot;angezeigt. NPR-29077: Hotfix für CQ-4246594
* (Touch-Benutzeroberfläche) Die Aktualisierung von Tags auf Seiten, die bereits mit verschiedenen Tags versehen sind, kann nicht per Massenvorgang durchgeführt werden. NPR-28729: Hotfix für CQ-4262922
* Das Öffnen der Variante in der Kartenansicht führt zu einem 500-Fehler. NPR-28611: Hotfix für CQ-4263571
* Rollout einer Struktur, die in einen primären Lead verschoben wurde, führt zu einem falschen `cq:moveTarget`. NPR-28968: Hotfix für CQ-4265280
...
* Wenn Sie auf ein Tag klicken, wird das globale Mausereignis entfernt und das Dialogfeld wird im verschiebbaren Modus gesperrt. NPR-28641: Hotfix für CUI-7294
...
* Die Option zur Auswahl von Elementen pro Seite auf der Seite &quot;Ansicht des Richtliniensatzes&quot;wurde aktiviert.
...
* Eine freigegebene Warteschlangenantwort öffnet ein Flash-Element im Arbeitsbereich HTML5. NPR-29161: Hotfix für CQ-4266498
* Die Übermittlung über Workspace ist nicht möglich, wenn die Schaltfläche ein Umlauffenster enthält. NPR-29014: Hotfix für CQ-4263172

#### Forms - Document Security {#forms-document-security}

* Aktivieren Sie die Option, um Elemente pro Seite auf der Seite mit der Ansicht des Richtliniensatzes auszuwählen. NPR-29243: Hotfix für CQ-4268567 und CQ-4265132
...
* Bei der Vorschau einer XDP als PDF wird ein anderes Verhalten beobachtet als bei der XDP-HTML in Designer. NPR-28602: Hotfix für CQ-4260239
...
* Eine aria-Beschriftung für Listen- und Kartenansichtsschaltflächen wurde hinzugefügt.
...
* Eine aria-Beschriftung für Listen- und Kartenansichtsschaltflächen wurde hinzugefügt. NPR-27736: Hotfix für CQ-4254027
...
* Den Sonderzeichen wird im Suchfeld das Escape-Zeichen (\) vorangestellt. NPR-27839: Hotfix für CQ-4259757
...
* Liste `loaderPromises` wird nicht gelöscht, nachdem der Inhaltsrahmen in editor.js geladen wurde NPR-27768: Hotfix für CQ-4205337
* Eine Vorlagenrichtlinie kann nicht für verschachtelte Parsys festgelegt werden, ohne sie für die übergeordnete Komponente festzulegen. NPR-27987: Hotfix für CQ-4246095
...
* Der Abbruch der LiveCopy-Vererbung funktioniert jetzt ordnungsgemäß für zielgerichtete Container, da Aktionen angezeigt werden. NPR-28129: Hotfix für CQ-4259813

#### Replikation {#replication-1}

* DispatcherFlushRules haben die Replikation in 6.3.3.1 NPR-28150 unterbrochen: Hotfix für CQ-4261401
...
* Die Konfiguration der Komponentenoption Target ist für die Zielgruppen außer der Standardzielgruppe nicht verfügbar. Hotfix für CQ-4261370
...
* Das Hinzufügen oder Entfernen von Elementen in der Dropdown-Liste wird beim Aktivieren der Kontrollkästchen nicht aktualisiert. NPR-28224: Hotfix für CQ-4252834
...
* Unterstützung für die Paginierung zur Gruppenauflistungsseite bei der Veröffentlichung aktiviert.
* Die unreadCount-Benachrichtigung kann nun mit jeder beliebigen Zahl konfiguriert werden. Der Standardwert ist auf 20 festgelegt.
...
* Download als Link-Freigabe-E-Mail gibt eine leere oder beschädigte ZIP-Datei zurück. NPR-27997: Hotfix für CQ-4259686
...
* Nullzeiger-Ausnahme bei der Verwendung eines Kernkomponenten-Formulars zusammen mit einem Foundation-Formular. NPR-27333: Hotfix für CQ-4249176
...
* Wenn der Rich-Text-Editor mit mehreren Feldern kombiniert wird, tritt der Fehler Uncaught TypeError: fieldAPI.getName keine Funktion beim Fehler foundation.js auf. NPR-27146: Hotfix für CQ-4253155, CQ-4259967
* Der Fokus/Cursor bleibt auch beim Klicken auf ein Optionsfeld im Safari-Browser im Rich-Text-Editor. NPR-27144: Hotfix für CQ-4249635
* Die Seite wird als leer angezeigt, wenn der Benutzer versucht, das Inhaltsfragment zu bearbeiten. NPR-27669
...
* Nach Angabe von Haltepunkten in einer Dynamic Media-Komponente wird ein Bild nicht angezeigt. Hotfix für CQ-4256168
...
* Der Link zum Inhaltsfragmentmodell fehlt nach Anwendung des SP3-Patches. Hotfix für CQ-4259029

#### DAM - Benutzeroberfläche {#dam-ui}

* Die Benutzeroberfläche für Ordner-Metadatenschema ist nach der Installation von SP3 nicht mehr funktionsfähig. Hotfix für CQ-4257737
...
* Das Abonnementlimit des Benutzers ist auf 1000 begrenzt. NPR-27615: Hotfix für CQ-4254689
...
* Die Statusbeschriftung zur Aktivierung der Scorm-Ressource wird in der Benutzeroberfläche leer angezeigt. NPR-27152: Hotfix für CQ-4249994
* Nach Aktivierung von **Zulassen von privilegierten** sollten die berechtigten Mitglieder nur für Benutzer erstellt werden können, die Community-Mitglieder sind. NPR-27901: Hotfix für CQ-4251235
...
* Der Formularaufbau wurde auf die neueste Version von Handlebars aktualisiert.
...
* Bei aktivierter IDS-Entkopplung verknüpft der Workflow &quot;DAM-Update-Asset&quot;keine Verweise mehr. NPR-26135: Hotfix für CQ-4250933
* Das Dekomprimieren eines vom Entarchivierungsschritt erstellten Archivs mit einem Ordner mit dem Namen &quot;%&quot;wird nicht geöffnet. NPR-26275: Hotfix für CQ-4251482
* Ein einzelnes Anführungszeichen verhindert die Metadaten-Aktualisierung. NPR-26808: Hotfix für CQ-4254305
...
* Die Asset-Linkfreigabe erlaubt nicht das Hinzufügen von mehr als einem internen Benutzer mit einer numerischen Benutzer-ID. NPR-26206: Hotfix für CQ-4251466
* Korruptionsfall in ZIP-Dateien, die mit dem deflate64-Algorithmus komprimiert wurden. NPR-26793: Hotfix für CQ-4253995
* Der Prozess zur Erstellung von Miniaturansichten funktioniert bei komplexen PDF-Dateien nicht ordnungsgemäß, was zu Miniaturansichten führt, bei denen ein Teil des Bildes fehlt. NPR-26057: Hotfix für CQ-4250944
...
* Die Option **Ausgabeformat löschen** funktioniert nicht und gibt den Fehler &quot;Nichts zu löschen&quot;aus. NPR-26007: Hotfix für CQ-4213414
...
* Richtlinien steuern die Rich-Text-Editor-Funktionen im Dialogfeld &quot;Bearbeiten&quot;nicht. NPR-27059, NPR-26750: Hotfix für CQ-4241130
...
* Durch Hinzufügen von &quot;Sonderzeichen&quot;wird das Dialogfeld &quot;Rich-Text-Editor&quot;nach oben verschoben. NPR-26435: Hotfix für CQ-4249869
...
* Die Tag-Felder des Modells für strukturierte Inhaltsfragmente spiegeln keine Tag-Verschiebungsvorgänge wider. NPR-26801: Hotfix für CQ-4251805
...
* Zum Erstellen einer Variante als Live Copy muss der Benutzer die Seite aktualisieren, damit sie angezeigt wird. NPR-26663: Hotfix für CQ-4254328
* (Klassische Benutzeroberfläche) Wenn Sie zu den Seiteneigenschaften zurückkehren, verwendet das Miniaturbild nicht mehr die Vererbung, verschwindet vom Site-Administrator und Sidekick und das Bild wird als leer angezeigt. NPR-26562: Hotfix für CQ-4252346
...
* Beim gleichzeitigen Zugriff durch mehrere Replikationsagenten treten in Protokollen beim Zugriff auf den Zugriffstoken-Knoten Ausnahmen auf. NPR-26964: Hotfix für GRANITE-23276, Granite-23155

#### ContextHub {#contexthub}

* Die Datei &quot;`coral.js`&quot; enthält eine verwundbare Version der Bibliothek &quot;`handlebars.js`&quot;. Hotfix für CQ-4255377
...
* Bilder für Anhänge zeigen beim Erstellen eines Forumsbeitrags keine Miniaturansicht an. NPR-26380: Hotfix für CQ-4253105
* Das Plug-in &quot;Aus Word einfügen&quot;lädt nicht mehr als ein Bild. NPR-26728: Hotfix für CQ-4253638
...
* Das Abrufen von Daten vom Adobe Storage Resource Provider ist langsam. NPR-26237: Hotfix für NPR-24152
* Die Seite zur Komposition privater Nachrichten ist unberechenbar und langsam. NPR-26120: Hotfix für CQ-4250923
...
* Ein Problem bei der Suche nach der Forumkomponente. NPR-26577: Hotfix für CQ-4251303
...
* Das Löschen von Beiträgen funktioniert, gibt jedoch in der Konsole einen Fehler aus und der Beitrag bleibt in der Benutzeroberfläche sichtbar. NPR-26292: Hotfix für CQ-4252803
...
* Nullzeiger-Ausnahme beim Hinzufügen von Gruppen und Mitgliedern zu Rolleneinstellungen und beim Zulassen des privilegierten Mitglieds in der Blog-Funktion. NPR-21732, NPR-27176: Hotfix für CQ-4255909
* Beim Bearbeiten der Site und Hinzufügen von Mitgliedern in den Rolleneinstellungen wird eine Null-Pointer-Ausnahme ausgelöst. NPR-27132: Hotfix für CQ-4255909
...
* Die Wasserzeicheneinstellungen von Document Security können nicht erstellt oder bearbeitet werden. NPR-26267, NPR-26129: Hotfix für CQ-4250234
...
* Durch Bearbeiten und Speichern eines bearbeitbaren Moduls und anschließendes Öffnen oder Schließen der PDF-Vorschau wird die PDF- und HTML-Vorschau des Briefs sichtbar. Beide Vorschauen bleiben im selben Fenster funktionsfähig. NPR-26770: Hotfix für CQ-4253217

#### Forms – Workflow {#forms-workflow-2}

* Der Arbeitsbereich hängt gelegentlich und zeigt die Startpunkte wiederholt an. NPR-26461: Hotfix für CQ-4253439
...
* Der Arbeitsbereich kann nach Anwendung der Datei axis.jar nicht geöffnet werden. NPR-26131: Hotfix für CQ-4251126
...
* Eine Ausnahme wird ausgelöst, wenn eine Suchvorlage über die Administrator-Benutzeroberfläche festgelegt und diese dann für die Suche im AEM Forms-Arbeitsbereich verwendet wird. Hotfix für CQ-4255649
* Tracking-Details der Prozesse unter den Anwendungen mit Klammern-Symbol im Namen werden in HTML Workspace nicht angezeigt. Hotfix für CQ-4242101
* Das Speichern von Änderungen im Bildschirm &quot;Voreinstellungen&quot;von HTML Workspace löst eine Ausnahme aus. Hotfix für CQ-4241485
...
* Setzen Sie den Parameter Date().getTime().toString , um die Sitzung anstelle von Date.toString() zu initialisieren. Hotfix für CQ-4241483
* Beim Öffnen von /lc/ws wird eine verwundbare Zeichenausnahme im HTML-Parameter beobachtet. Hotfix für CQ-4241481
...
* Korrektur der im Bericht zur statischen Codeanalyse von PDFG gemeldeten Probleme. NPR-23251: Hotfix für CQ-4213930
...
AEM Cumulative Fix Pack 6.3.2.2 ist abhängig von AEM 6.3 Service Pack 2. Daher müssen Sie das AEM Cumulative Fix Pack 6.3.2.x-Paket nach der Installation von AEM 6.3 Service Pack 2 installieren. Installationsanweisungen finden Sie in den Versionshinweisen in [AEM 6.3 Service Pack 2](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions).
...
* Sicherstellen, dass die Renderbedingung ein gesundes Ergebnis zurückgibt, wenn expressionResolver null ist.
...
* Bei der Download-Größe wurden Abweichungen von den angezeigten Informationen festgestellt. NPR-23418: Hotfix für CQ-4242774
...
* Asset-Admin-Suchfacetten werden nach der Vorschau in den Suchbereichen ausgeblendet. NPR-23964: Hotfix für CQ-4244410
...
* Die Schaltfläche Publish/Veröffentlichung in Brand Portal rückgängig machen sollte nicht für Inhaltsfragmente verfügbar sein. NPR-23318: Hotfix für CQ-4245086
...
* MP4-Video-Asset in Dynamic Media S7 (DMS7) kann nicht kommentiert werden. NPR-22046: Hotfix für CQ-4215912
...
* Dynamische Ausgabedarstellungs-Anzeige-/Auswahlprobleme mit großer Bildvorgabenzahl. NPR-23151: Hotfix für CQ-4217511
* Problem mit Dynamic Media-Videokodierung - Launcher für Änderungen/Neuladungen. NPR-23237: Hotfix für CQ-4240260
* Korrektur zur Proxy-Verarbeitung für HTTP-Forwarder in Dynamic Media S7. NPR-24001: Hotfix für CQ-244140

### Sites {#sites-8}

* Diskrepanzen bei Query Builder aufgrund unterschiedlicher xPath-Übersetzung zwischen 6.2 und 6.3. NPR-23245: Hotfix für CQ-4240396
...
* Ein anderer Benutzer in einer anderen Sitzung kann eine Seite ändern, die von einem Benutzer in der ersten Sitzung gesperrt wurde. NPR-23057; Hotfix für CQ-4199017
* Korrigieren Sie die neu sortierbare Option in der Listenansicht. NPR-23065: Hotfix für CQ-4239321
...
* Die Rollout-Schaltfläche fehlt auf der Registerkarte &quot;Blueprint&quot;für XF-Varianten. NPR-23320: Hotfix für CQ-4240404
...
* Ungefähr In einem Ordner in Assets werden 80 Fragmente hinzugefügt. Wenn der Workflow über die Timeline-Konsole ausgelöst wird, treten Fehler auf. NPR-23393: Hotfix für CQ-4211216
...
* (Rich-Text-Editor) QuickInfos zeigen den Variablennamen des Plug-ins anstelle des lesbaren Plug-in-Namens. NPR-23550: Hotfix für CQ-4243269
...
* Die intelligente Sammlung zeigt nach dem Speichern keine Ergebnisse an, wenn die Tag-Eigenschaft in der Suchfacette verwendet wird. NPR-23401: Hotfix für Granite-21278
* Patch jQuery 1.12.4 von clientlib enthält Sicherheitskorrektur. NPR-24128: Hotfix für Granite-20058
* Internationalisierungs-Übersetzungen werden jetzt aktualisiert, wenn das Bundle neu gestartet wird. NPR-23193: Hotfix für SLING-7190
...
* (Target) Kampagnen werden bei Verwendung eines API-Typs wie XML nicht aktiviert. NPR-23199: Hotfix für CQ-4240936****
* Die Replikation der Konfigurationsreferenzen schlägt mit einer Zwischenordnerstruktur fehl. NPR-23485: Hotfix für CQ-4242751
...
* DatePicker unterstützt nicht das manuelle Festlegen von Hinweisen zu externen Typen, die von einem ausgeblendeten Feld festgelegt werden. Beim Ändern des Typhinweises wird ein Konvertierungsfehler ausgegeben. NPR-23371: Hotfix für Granite-21194
* Coral.ColumnView: Unterstützung für Shift+Click hinzugefügt. NPR-23404: Hotfix für Granite-13338
* Wählen Sie RT überprüft nicht, wenn ein Element mit einem leeren Wert ausgewählt ist. NPR-23405: Hotfix für Granite-21283
...
* In Gemeinden zu suchen versagt nur wenige Worte. NPR-23256: Hotfix für CQ-4240717
...
* (ContextPath) Die Breaking Message-Funktionalität schlägt bei Jetty-Konfigurationen fehl und bei der Suche nach Gruppenmitgliedern in der Community-Gruppenmitgliederliste treten Fehler auf. NPR-23336: Hotfix für CQ-4241519, CQ-4242080
...
* Probleme bei der Durchführung einer Suche nach der Forumkomponente. NPR-23838: Hotfix für CQ-4243770
...
* Kennzeichnungsgründe von Benutzern, die nicht markiert sind, bleiben sichtbar. NPR-23974: Hotfix für CQ-4243822
...
* Ein numerisches Feld entspricht nicht einem Mindestwert. NPR-23967: Hotfix für CQ-4244830
...
* Der Arbeitsbereich kann nach Anwendung der neuen Datei axis.jar nicht geöffnet werden. NPR-23316
...
* Der Papieraufzeichnungsdienst stürzt bei gleichzeitiger Verarbeitung von TIFF-Dateien ab (etwa 50 Kilobyte groß). NPR-23556
...
* Beim Ändern des Titels oder des Miniaturbilds in den Einstellungen des Asset-Ordners werden die ursprüngliche Gruppe und die Berechtigungen des Ordners überschrieben. NPR-22171: Hotfix für CQ-4216080
* Die Benutzeroberfläche gibt den Fehler &quot;Publish to Brand Portal failed&quot;aus, während der Auftrag zur Replikationswarteschlange hinzugefügt und Assets in Brand Portal veröffentlicht werden. NPR-22179: Hotfix für CQ-4205273
...
* AEM gibt beim Versuch, ein Asset-Schema von `/conf/global` in `/conf/mytenant` zu kopieren, einen StackOverflow-Fehler aus. NPR-22489: Hotfix für CQ-4235875
...
* HTTP 504: Gateway-Zeitüberschreitungsfehler beim Versuch, Sammlungen über einen Freigabe-Link freizugeben. NPR-21928: Hotfix für CQ-4234507
...
* (DAM) Mehrere Sicherheitslücken beim Cross-Site Scripting (XSS) beim Hinzufügen zum Sammlungsassistenten. NPR-22432: Hotfix für CQ-4327086
...
* Legen Sie beim Veröffentlichen von Assets in Brand Portal die Standardoption &quot;Öffentliche Freigabe&quot;fest. NPR-21931: Hotfix für CQ-4218816
...
* Bearbeitbare Strukturkomponenten verlieren bei der Bearbeitung die CSS-Klassennamen, die für das responsive Raster erforderlich sind. NPR-21741: Hotfix für CQ-4232374
* (TouchUI) Mehrere Schwachstellen bei Cross-Site Scripting (XSS) für HTL-Komponenten. NPR-21899: Hotfix für CQ-4232511
* Der Ressourcentyp für Inhaltsfragmente mit gemischten Medien kann nicht geändert werden. NPR-21907: Hotfix für CQ-4233401
* RTE-Vollbild Im Dialogfeld &quot;Touch-Benutzeroberfläche&quot;werden die RTE-Plug-ins ausgeblendet. NPR-22034: Hotfix für CQ-4235457
...
* (Klassische Benutzeroberfläche) Die Ausgabe-HTML des Rich-Text-Editors fügt &quot;list-position-style: inside;&quot;als Inline-Stil zum &lt;ul>-Tag hinzu. NPR-22145: Hotfix für CRTE-114
* Stellen Sie sicher, dass TreeNode auf das Attribut name zurückfällt, wenn der Text leer ist. NPR-22146: Hotfix für CQ-4234724/CQ-4236300
...
* Persistenzprobleme, wenn ContextHub-Stores die standardmäßige Persistenzschicht während der Initialisierung überschreiben. NPR-22479: Hotfix für CQ-4218399
* Beim Start mit mehreren Seiten werden keine Unterseiten auf Veröffentlichungsservern veröffentlicht, wenn im ersten Inhaltsstamm die Option &quot;Unterseiten einschließen&quot;nicht aktiviert ist. NPR-22482: Hotfix für CQ-4237818
* (Touch-Benutzeroberfläche) Durch das Löschen von Launches über die Konsole &quot;Klassische Benutzeroberfläche&quot;können alle Seiten nicht bearbeitet werden. NPR-22491: Hotfix für CQ-4225074
...
* Nach dem Spiegeln eines Bildes, das der Bildkomponente auf einer Seite hinzugefügt wurde, werden die Änderungen nicht gespeichert und das Originalbild wird auf der Seite angezeigt. Der Bild-Kernkomponente wurde Rendering-Unterstützung über [https://github.com/adobe/aem-core-wcm-components/pull/141](https://github.com/adobe/aem-core-wcm-components/pull/141) hinzugefügt. NPR-22801: Hotfix für CQ-4221539
* Wenn der Benutzer versucht, den vorhandenen Anker aus dem Ankermenü zu löschen, wird das Komponentenfenster des Rich-Text-Editors geschlossen und die Änderungen bleiben nicht gespeichert. NPR-22802: Hotfix für CQ-4238167
* Der Omnisearch-Filter zeigt nicht alle Aktionen in der Sites-Konsole an. NPR-22804: Hotfix für CQ-4239007
...
* Das Aktivieren einer Seite mit Veröffentlichungsinstanzen führt zu einem grünen Status, anstatt zu gelb zu werden. NPR-22927: Hotfix für CQ-4236310
...
* Die Target-Engine (mbox.js, at.js) verwendet keine verwalteten URLs. Außerdem verwendet URLs mit Doppelpunkten, die bei bestimmten Implementierungen fehlschlagen können. NPR-22366: Hotfix für CQ-4237854
* Bei der Bereitstellung eines benutzerdefinierten at.js oder mbox.js wird das enthaltene Skript als Text anstatt als HTML-Tags in die Seite geschrieben. NPR-22441: Hotfix für CQ-4203691
...
* Die PersonalizationDataSource gibt aufgrund des fehlenden `jcr:content` -Knotens eine Nullzeigerausnahme aus. NPR-22850: Hotfix für CQ-4222122
* AEM Targeting schlägt bei der Verwendung der nicht englischen Sprache fehl. NPR-22917: Hotfix für CQ-4218213
...
* Benutzer können keine statischen Param-Werte im Mbox-Aufruf sehen, was beim Testen mit AT.js als Client-Bibliothek in der Cloud-Konfiguration sichtbar ist. NPR-21930: Hotfix für CQ-4234520
...
* (Klassische Benutzeroberfläche) Die Komponente zeigt die Standardwerte an, selbst wenn der zugehörige Formulardatenmodelldienst auf ein leeres Feld festgelegt ist. NPR-22272: Hotfix für GRANITE-19744

### Granite {#granite-2}

* Stabilitätsprobleme mit der Asset-Freigabe der AEM-Publisher-Instanz, verursacht durch ein Speicherleck. NPR-22205, NPR-23178: Hotfix für Sling-5668, Sling-7292 und Sling-7470.
...
* LogbackManager kann einige OSGi-Konfigurationen zum Zeitpunkt des Starts vermissen. NPR-23060: Hotfix für Granite-19791

### Commerce {#commerce-3}

* Aktivieren Sie die Erstellung von Workflows im Menü Experience Fragments . NPR-22347: Hotfix für CQ-4221661
...
* PDF-Dateien, die PDF/A-2a- oder PDF/A-3a-kompatibel sind, werden nun unterstützt.

### Forms-Add-on-Paket {#forms-add-on-package-9}

#### Forms-Admin-Benutzeroberfläche {#forms-admin-ui}

* Das Kennwort wird im Klartext angezeigt, wenn Sie das Kennwortfeld auf den Seiten zur ECM Connectors-Konfiguration überprüfen. NPR-22508: Hotfix für CQ-4236065
...
* Benutzerdefinierte Funktionen für den Regeleditor fügen ein zusätzliches hinzu, nach dem Funktionsaufruf. Daher schlagen sie bei der Validierung fehl, obwohl die benutzerdefinierte Funktion &quot;true&quot;zurückgibt. NPR-22481: Hotfix für CQ-4235499
* Unabhängig vom ausgewählten Datumsmuster folgt die Komponente für die Datumsauswahl nicht dem Muster bei der Anzeige von Mindest- und Höchstvalidierungsmeldungen. NPR-22444: Hotfix für CQ-4236269
* Das Datumsformat, das in der Sendeanforderung gesendet wird, sollte mit dem Muster übereinstimmen, das in der Datumsauswahlkomponente angegeben ist. NPR-22384
...
* Die AEM Forms-Container-Komponente kann nicht bearbeitet werden, nachdem das falsche Formular auf der AEM Sites-Seite konfiguriert wurde. Hotfix für CQ-4237456
* Entwicklungstests schlagen bei Ausführung auf JEE-Servern fehl. Hotfix für CQ-4222082
...
* Forms, die nach dem Veröffentlichen der Seite geändert werden, werden nicht erneut veröffentlicht. NPR-23013: Hotfix für CQ-4236566
...
* (HTML Workspace) Vorbereitende Daten werden beim Schließen eines Formulars im Arbeitsbereich ausgelöst. NPR-21127: Hotfix für CQ-4224574
...
* Browser können keine in HTML Forms eingegebenen Anmeldeinformationen speichern. NPR-21762: Hotfix für CQ-4206543
...
* PDF-Dateien, die PDF/A-2a- oder PDF/A-3a-kompatibel sind, werden nun unterstützt. NPR-23021: Hotfix für CQ-4214172

#### Forms Designer {#forms-designer-1}

* Die PDF/UA-ID fehlt, wenn sie von Designer als PDF gespeichert wird. NPR-23137
...
* Inline-Hyperlinks, die in Designer definiert sind, werden nicht mit Tags versehen oder sie haben alternativen Text, wenn sie als PDF aus Designer gespeichert werden. NPR-23133
...
* Beim digitalen Signieren eines PDF-Dokuments über HSM ist eine Ausnahme aufgetreten. NPR-21154: Hotfix für CQ-4226978
...
* Assets mit Leerzeichen können nicht von der Lizenzprüfungsseite heruntergeladen werden. NPR-20067: Hotfix für CQ-4216557
* Verarbeitungsfehler beim Hochladen von PSB-Dateien mit mehreren Alpha-Ebenen. NPR-20250: Hotfix für CQ-4220869
* Benutzer können keine Assets mit langen Dateinamen und einem definierten Haftungsausschluss herunterladen. NPR-20254
...
* Zu viele Zeichen in OmniSearch können zum Absturz des AEM-Servers führen. NPR-20434: Hotfix für CQ-4223602
...
* AEM Dynamic Media Classic (früher Scene7) kann Assets nicht vom AEM Server synchronisieren. Dieses Problem tritt auf, wenn der Zielpfad in der Cloud Service-Konfiguration auf einen Stammverzeichnis für den Pfad verweist. CQ-4228265
...
* Der eingegebene Workflow-Name sollte beim Veröffentlichen einer Seite über Veröffentlichung verwalten im Feld &quot;Benachrichtigung&quot;verfügbar sein. NPR-20046: Hotfix für CQ-4221586
...
* Das Rich-Text-Plug-in funktioniert sowohl für Inline- als auch für Vollbildbalken in der Touch-Benutzeroberfläche mit mehreren Feldern nicht. NPR-20973
...
* Inkonsistente Suchergebnisse bei Suchergebniskomponente. NPR-20070: Hotfix für CQ-4220913
...
* Nach dem Erstellen einer Communities-Site können Benutzer sie nicht aus der Sitemap öffnen, da der Kontextpfad nicht der URL vorangestellt wird. NPR-20730
...
* Bei der Konfiguration des Search&amp;Promote Cloud-Dienstes wird die Methode zum Abrufen von Formularen ignoriert, sodass sie auf der Autoreninstanz nicht mehr verwendet werden kann. NPR-20447: Hotfix für CQ-4206076
* Eine unübersichtliche Filterdefinition im Inhaltspaket bewirkt, dass Pfade bei der Installation der Search&amp;Promote-Funktion überschrieben werden. NPR-20808

### Mobile On-Demand {#mobile-on-demand}

* Metadateneigenschaften für Assets vom Typ TXT werden bei jeder Anzeige ihrer Eigenschaften in verschiedenen Metadaten-Editoren angezeigt. NPR-20239
...
* Die Anmerkungsebene des Seiteneditors funktioniert in Internet Explorer 11 nicht ordnungsgemäß. NPR-20222: Hotfix für CQ-4222818
* Sitzungsfehler beim Festlegen des Benutzeragenten als Administrator im Replikationsagenten. NPR-20578
* Die requestAttributes ist jetzt für die anderen data-sly-resource -Anweisungen nicht mehr festgelegt. NPR-20639: Hotfix für 4226206
* Es wurden Probleme mit Curl Head-Anforderungen für OOTB-Assets in AEM behoben. NPR-20781: Hotfix für CQ-4221520

### Projekte {#projects-1}

* Das Laden verschiedener Projekte über die Projektekonsole dauert länger. NPR-20314
* Bei der Installation von AEM 6.3.0.1 wird der Keystore des Benutzers für `dam-update-service` entfernt. NPR-20018
* In einigen benutzerdefinierten Bereitstellungen dauert es länger, bis Benutzer, die versuchen, einen Verantwortlichen im addTask-Modul auszuwählen, die Liste in der Benutzerauswahl füllen. NPR-20283: Hotfix für CQ-4224193

### Benutzeroberfläche {#user-interface-3}

* Das Feld Farbe ist trotz der Attribute im Dialogfeld auf &quot;immer erforderlich&quot;eingestellt. NPR-19702
* Die Bildlaufleiste wird in Internet Explorer 11 für eine Komponente mit mehreren Feldern nicht im Vollbildmodus angezeigt. NPR-20261: Hotfix für CQ-4219782
...
* Benutzende werden nicht über die Workflow-Aufgaben in ihrem Posteingang informiert. NPR-20213: Hotfix für CQ-4221639
* Die vorkonfigurierte Granite-Benutzerauswahl lädt keine Benutzenden, wenn im Dialogfeld „Teilnehmer – Schritt“ des Workflow-Modells auf die Dropdown-Liste geklickt wird. NPR-20236
...
* Der Wert der Switch-Komponente kann nicht zwischen &quot;true&quot;und &quot;false&quot;festgelegt werden. NPR-21111
...
* Der Name eines XDP-Formularobjekts wie eines Teilformulars wird als QuickInfo angezeigt, wenn es in den Konfigurationen für Barrierefreiheit nicht definiert ist. NPR-20523

### JEE-Installationsprogramm von Forms {#forms-jee-installer-9}

#### Prozessverwaltung {#process-management-2}

* Der Startpunkt FormSetPrefillApp füllt in der AEM Forms-App keine Formularsatzfelder vorab aus. NPR-20950
...
* Die Aktion &quot;In Brand Portal veröffentlichen&quot;für das standardmäßige Metadatenschema-Formular wurde aktiviert.
...
* Server-seitiges Rendering der Zeit durch eine Foundation-Zeit-Komponente ersetzt.
* Veröffentlichungs-Tags von AEM in Brand Portal über die Tagadmin-/Tagging-Konsole aktiviert.
* Die JSON-API wurde veröffentlicht, um Inhaltsfragmente zu verwenden.
* Das integrierte Repository (Apache Jackrabbit Oak) wird auf Version 1.6.5 aktualisiert.

### Assets {#assets-11}

* Wenn Sie zwei Felder mit derselben Eigenschaft mit unterschiedlichen Eigenschaftstypen zuordnen, wird ein interner Fehler ausgegeben. NPR-19462: HF für CQ-4216828
* dc:title und dc:description ändert sich nicht in einen Mehrfeld-Wert in CRXDE Lite.  NPR-19570: HF für CQ-4209086
...
* Eine vollständige Liste der Seiten/Assets kann nicht mit Chrome in der Spaltenansicht geladen werden. NPR-19566: Hotfix für CQ-4214248
...
* Das Feld Targeting-Engine im Konfigurationsassistenten ist auf ContextHub (AEM) anstelle von Adobe Target eingestellt. NPR-19320: Hotfix für CQ-4218465
* Der Zielgruppenabschnitt wird beim Erstellen des Erlebnisses beschädigt. NPR-19110
* Das Dialogfeld Targeting wird nicht im Targeting-Modus angezeigt, wenn ein Zielmodul bearbeitet und mehrmals gespeichert wird. NPR-19144: Hotfix für CQ-4216708
...
* WCMMode.EDIT funktioniert nicht für Targeting-Komponenten im Authoring-Modus. NPR-19387
* Die JSON-API wurde veröffentlicht, um Inhaltsfragmente zu verwenden. NPR-19500
...
* Rendering-Probleme mit der AEM Artikelkonsole als Verwendung von Bildern in voller Größe verlangsamen die Arbeit. NPR-19088
...
* Benutzerdefinierte Tag-Lib, die als Skript implementierte Referenztags enthält, werden nach der Aktualisierung auf AEM 6.3 nicht gefunden. NPR-19087
* Fehlerbehebungen bei HTL für AEM 6.3.1. NPR-19161
* Das Rich-Text-Feld kann in den Komponenten mit mehreren Feldern nicht bearbeitet werden. NPR-19604: Hotfix für Granite-16755
...
* Die Schaltfläche Workflow starten nach Auswahl eines XF-Varianten-Editors hat keine Auswirkungen. NPR-19642: Hotfix für CQ-4207796

### Projekte {#projects-2}

* Projekt-Editoren können keine Assets kopieren und in den Projekt-Asset-Ordner einfügen. NPR-19619: Hotfix für CQ-4215321
...
* OOTB-Eigenschaften und Bildausrichtungseigenschaften werden beim Bearbeiten eines Bildes in der klassischen Benutzeroberfläche nicht angezeigt. NPR-19488: Hotfix für CQ-4217914

### Benutzeroberfläche {#user-interface-4}

* Bei Verwendung des Google Chrome-Browsers können Benutzer die vollständige Liste der Seiten/Assets nicht über die Spaltenansicht in der TouchUI laden. NPR-19566: Hotfix für CQ-4214248

### Brand Portal {#brand-portal-1}

* Assets können nicht mit Kommentaren und Anmerkungen aus AEM veröffentlicht werden. NPR-19590: Hotfix für CQ-4218386
* Aktivieren von Veröffentlichungs-Tags von AEM in Brand Portal über die Tagadmin-/Tagging-Konsole NPR-20271: Hotfix für CQ-4223948
* Das Feld „Aktiviert“ wurde in der Benutzeroberfläche der Brand Portal-Cloud-Service-Konfiguration korrigiert. Hotfix für CQ-4211101
...
* Der Workflow &quot;An JEE übermitteln&quot;gibt den Ausgabeparameter von JEE-Seite nicht an AEM zurück und gibt den Fehler &quot;Ignorieren, da der Wert nicht primitiv ist&quot;aus. NPR-20265
* Adaptive Formulare lassen PDFs nicht als Anhang in Safari zu. NPR-19625
* RestoreGuideState überschreibt die customcontextproperty map. CQ-4222877
* Beim Konfigurieren von Google `reCaptcha` mit Cloud Service werden in Umgebungen, in denen die Konfiguration von org.apache.http.proxyconfiguration für externe Verbindungen erforderlich ist, POST-Aufrufe offenbar nicht über PROXY ausgeführt. NPR-20454
* Adaptive Forms basierend auf XSD-Schemata sendet fehlerhafte XML-Werte für numerische Felder bei Installationen mit Gebietsschemas, die ein anderes Dezimaltrennzeichen als Punkt (.) haben zu Fehlern führt. NPR-20444
* Proxy-Einstellungen, die für &quot;Apache HTTP Components Proxy Configuration&quot;festgelegt sind, werden beim Herstellen einer HTTP-Anforderung an einen Drittanbieter-Server nicht berücksichtigt. Verbindungs-Timeout-Probleme mit HTTP GET- oder POST-Aufrufen. NPR-20457, NPR-20456, NPR-20455, NPR-20451
...
* Mehrzeiliges Textfeld (TextArea) behält keine neuen Zeilenzeichen oder Textumbrüche bei, nachdem Daten in HTML Workspace übermittelt wurden. NPR-20085

#### Prozessberichterstellung {#process-reporting}

* Prozessberichte rufen Daten aufgrund der Nullzeiger-Ausnahme nicht ordnungsgemäß ab. NPR-19759
...
* Das Dropdown-Feld Metadatenschema kann nicht als obligatorisch festgelegt werden, da die obligatorische Feldvalidierung für Assets fehlt. NPR-17882: FP für CQ-4208373
...
* Das Standard-Metadatenschema verursacht einen Fehler bei der Überprüfung von Inhaltsfragmenten. NPR-17769: Hotfix für CQ-4211111
...
* Überprüfungsaufgabe für Assets im Ordner &quot;Japanisch&quot;funktioniert nicht. CQ-4204782
* Eine Nullzeiger-Ausnahme tritt auf, wenn ein Asset von der Eigenschaftenseite verschoben wird. CQ-4204251
...
* Probleme mit dem Hinzufügen neuer Registerkarten im Metadatenschema-Formular, wenn es in Chrome auf Hybridgeräten bearbeitet wird. CQ-4201810
...
* Benutzer mit schreibgeschützten Berechtigungen für die App können keine Vorschau von Inhalten aus dem AEM Mobile Content Management anzeigen. NPR-17486: CFP für CQ-4209690
* Die Schaltfläche Katalog erstellen funktioniert nicht in der Spaltenansicht der Katalogkonsole. CQ-4209952

### Sites {#sites-12}

* Probleme mit dem Einbetten von Bild-/Videokomponenten über das data-sly-resource-Attribut. NPR-18182: CFP für CQ-4212100
* Geänderte lokalisierte Komponenten werden nicht in ihrem ursprünglichen Formular wiederhergestellt, wenn die Vererbung in einer Live Copy erneut angewendet wird. NPR-18172: Hotfix für CQ-4211379
...
* Der Seitenname wird nicht gemäß der Konvention für lange Seitentitel generiert. NPR-17633: Hotfix für CQ-4209056
* Probleme mit der Seitenerstellung in der Touch-optimierten Benutzeroberfläche in AEM 6.3, wenn auf JBoss® EAP 6.4 bereitgestellt. NPR-17589: Hotfix von CQ-4210137.
* Der Workflow-Statusanbieter veranlasst die Sperrung der Instanz, wenn verschachtelte Gruppen vorhanden sind. NPR-17556: CFP für CQ-4202056
...
* Beim Festlegen einer Marke/Zone auf eine Stammseite einer Site kann die Vererbung nach dem Abbrechen für Bereiche in Unterseiten nicht wiederhergestellt werden. NPR-17753: Hotfix für CQ-4210139
...
* Beim Bearbeiten einer Aufgabe aus dem Posteingang tritt ein Fehler mit dem nicht analysierbaren Datum auf. CQ-4208749
...
* Fehlerbehebungen in Textmodulen für Correspondence Management, Briefvorschau und programmgesteuertem Start zum Erstellen einer Correspondence Management-Benutzeroberfläche.
...
* Es wurde Unterstützung zum Erfassen von Prüfereignissen für das Freihand-Signaturfeld hinzugefügt.

### Forms-Add-on-Paket {#forms-add-on-package-12}

**Korrespondenzverwaltung**

* Beim Bearbeiten eines Correspondence Management-Fragments zeigt der Texteditor Inline-Bedingungen zusammen mit dem verarbeiteten Text an. CQ-4211930
* Beim Erstellen eines Correspondence Management-Briefs wird die Beschreibung des Briefs nicht gespeichert. NPR-18089
* Der zusätzliche Rand über und unter einer Liste mit Aufzählungszeichen ist im Texteditor sichtbar, jedoch nicht in der HTML- und PDF-Ausgabedarstellung. NPR-18126
...
* Wenn neue Inhalte hinzugefügt werden oder die `Enter`-Taste gedrückt wird, wird dem Textmodul ein div-Tag hinzugefügt. NPR-18240
...
* Der PDF Generator-Dienst kann keine Bilder mit einer Größe von mehr als 100 MB in PDF-Dokumente konvertieren. CQ-4208628
* Bei Verwendung des PDF Generator-Dienstes mit einem japanischen Spracherkennungs-OCR wird eine invertierte PDF generiert. NPR-17602
...
* Microsoft® Excel und Microsoft® PowerPoint brauchen länger, um die mit AEM Document Security Extension for Microsoft® Office geschützten Dokumente zu öffnen. CQ-4212358
...
>[!NOTE]
>
>Adobe empfiehlt, dass Sie die Validierung für jedes neue Installationspaket ausführen, bevor Sie versuchen, das Paket zu installieren. Vor der Überprüfung werden alle Fehler analysiert und protokolliert, die vor der Installation gefunden wurden, und die Benutzer werden proaktiv vor solchen Fehlern gewarnt.
>
>Sie können unter [https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) auf die Dokumentation für die Validierungsoption zugreifen.

* AEM 6.3.3.0 ist eine Voraussetzung für CFP. Detaillierte Anweisungen zum Aktualisieren einer AEM auf AEM 6.3 finden Sie in der [Upgrade-Dokumentation](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) .
...
### Installieren Sie das Cumulative Fix Pack über die Software-Verteilung {#install-the-cumulative-fix-pack-via-package-share}

1. Klicken Sie auf den Link [Software-Verteilung](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq640/cumulativefixpack/aem-6.4.8-cfp-2.0.zip), um das Paket herunterzuladen.
...
>[!NOTE]
>
>Wenn Sie Version 6.3.3.0 oder höher installieren, führen Sie das folgende Verfahren aus, um die Einstellungen für den JBoss®-Anwendungsserver zu konfigurieren. Wenn Sie 6.3.3.0 auf dem AEM Forms Server installieren, der auf Oracle WebLogic- oder IBM® WebSphere-Programm-Servern ausgeführt wird, ist keine zusätzliche Konfiguration erforderlich. Weitere Informationen finden Sie unter [AEM 6.3.3.0 – Versionshinweise](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions).
...
* Die folgenden Fehler und Warnungen können während der Installation von AEM CFP 6.3.3.x auftreten und können ignoriert werden:
   ...
   * org.apache.sling.engine.impl.SlingRequestProcessorImpl ServletResolver-Dienst fehlt, kann keine Serviceanfragen senden, Versandstatus 503
...
* Ab 6.3.1.2 wurde die Schaltfläche Publish zu Brand Portal für Smart-Sammlungen entfernt.
...
* Aufgrund vieler Anforderungen in der Admin-Suchfunktion wird eine hohe CPU-Auslastung beobachtet. NPR-24229
...
>[!NOTE]
>
>Diese Konfigurationseinstellung gilt für 6.3.2.2 und höher. Sie werden angewiesen, die Richtlinien für Zugriffssteuerungslisten (ACL) manuell über CRX-DE zu aktualisieren, da ACLs aufgrund von &quot;merge_preserve&quot;acHandling nicht über die CFP-Installation aktualisiert werden.
...
`2)` Unter dem Pfad „/content/usergenerated“
...
Der Standardwert ist 1. Überschreiben Sie den Wert durch Überlagern der Datei &quot;constants.js&quot;(`/libs/cq/ui/widgets/source/constants.js`), wodurch die Kommentarzeichen für die Eigenschaft `CQ.PAGE_PROPERTIES_MAX_RECURSION_LEVEL` aufgehoben werden. Anschließend weisen Sie ihm den erforderlichen Wert zu (die maximale Tiefe unter dem `/jcr:content` der Seite, in der die Daten der Seiteneigenschaften gespeichert werden).

**Wenn die Benutzerin bzw. der Benutzer mehrere Seitenvarianten erstellen muss, sodass die Anzahl der Knoten unter dem `/jcr:content`-Knoten größer als 1.000 ist, führen Sie die folgenden Schritte aus, um Konfigurationsänderungen vorzunehmen:**

* Konfigurieren Sie die Eigenschaft JSON Max results von Apache Sling.
* Servlet mit `/system/console/ configMgr` abrufen.
* Setzen Sie den Wert auf eine Zahl > 1.000 (der aktuelle Standard), sodass diese Zahl größer ist als die Gesamtanzahl der Knoten in der `/jcr:content`-Unterstruktur bis zur oben konfigurierten Tiefe.

Dadurch kann das Sling-GET-Servlet alle erforderlichen Knoten zurückgeben.

## Uber Jar {#uber-jar}

Das Uber Jar für 6.3.3.8 ist im Adobe Public Maven-Repository verfügbar.

Informationen zur Verwendung von Uber Jar in einem Maven-Projekt finden Sie unter [Verwendung von Uber Jar](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) und Einschließen der folgenden Abhängigkeit in Ihren Projekt-POM:
...
|----|-----|-----|-----|
| Integration von Assets und Adobe Creative Cloud | [Die gemeinsame Nutzung von AEM-Ordnern in Creative Cloud](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) wurde in AEM 6.2 eingeführt, um Benutzern von Creative Cloud den Zugang zu den Assets von AEM zu ermöglichen. Eine in der Creative Cloud-Anwendung veröffentlichte neue Funktion, Adobe Asset Link, bietet ein besseres Benutzererlebnis. Darüber hinaus bietet es einen leistungsfähigeren Zugriff auf Assets von AEM direkt aus Photoshop, InDesign und Illustrator.</br></br> Adobe wird die Ordnerfreigabe nicht weiter verbessern. Obwohl die Funktion in AEM enthalten ist, wird den Kundinnen und Kunden empfohlen, den Ersatz zu verwenden. | Adobe Asset Link oder Desktop-Programm. Weitere Informationen finden Sie im Artikel [AEM Creative Cloud integration](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) . | AEM 6.3.3.x |
...
>[!MORELIKETHIS]
>
>* [Versionen und Aktualisierungen von AEM](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/aem-releases-updates)
>* [Seite mit den AEM 6.3 Hotfixes](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/aem-releases-updates)
...
>* Abonnieren Sie [Adobe Priority Product Updates](https://www.adobe.com/subscription/priority-product-update.html)

...
# AEM 6.2 Cumulative Fix Pack-Versionshinweise{#release-notes-aem-cumulative-fix-pack}
...
AEM Cumulative Fix Pack 6.2 SP1-CFP20 ist das letzte Cumulative Fix Pack für AEM 6.2 und ist ein wichtiges Update, das wichtige kundenspezifische Korrekturen seit der allgemeinen Verfügbarkeit von [AEM 6.2 SP1](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) enthält.

>[!CAUTION]
>
>Die CFP-Anwendung ohne Überprüfung der Kompatibilität zwischen installierten Feature Packs kann zu einem Systemausfall oder zum Verlust benutzerdefinierter Konfigurationen führen, wofür die Wiederherstellung anhand eines Backups oder eine Problembehebung erforderlich sein könnte.
...
>[!NOTE]
>
>Die AEM Forms-Kundschaft muss unbedingt beachten, das AEM Forms-Add-on-Paket erst nach der Installation jeglicher AEM Service Packs, Cumulative Service Packs oder Feature Packs zu installieren.
...
* Bei der Vorschau des Briefes als PDF berücksichtigt das auf der Hauptseite platzierte Textfeld nicht den auf der Registerkarte „Daten“ oder gemäß der angegebenen Datenverknüpfung festgelegten Wert. NPR-29239: Hotfix für CQ-4266856.
...
* Ein DAM-Ordner kann nicht umbenannt werden, wenn die Berechtigung „ACL bearbeiten“ fehlt. NPR-27555: Hotfix für CQ-104652
* Der Bildvorgabeneditor in 6.2.1 CFP 17 und höher reagiert nicht. NPR-28147: Hotfix für CQ-4261041
...
* Die Anzeige des Symbols zum Unterbrechen der Vererbung ist nicht kohärent. NPR-27671: Hotfix für CQ-4257779
...
* Die Download-Funktionalität verwendet AEM Assets über ein Asset-Download-Servlet, mit dem anonyme Benutzende alle Assets herunterladen können. NPR-27054: Hotfix für CQ-4254732
...
* Umleitungen zur Kernseitenkomponente werden nun unterstützt. NPR-26576: Hotfix für CQ-110529
...
* Beim Kopieren und Einfügen von Text werden unerwünschte &lt;br>-Elemente im Inhaltsfragment eingefügt. NPR-26660: Hotfix für CRTE-151
...
* Aufgrund des Sonderzeichens Geviertstrich hat Publisher Probleme beim Leeren des Cache. NPR-27199: Hotfix für CQ-4242790
...
* Die RTE-Rich-Text-Editor-Symbolleiste verdeckt die Auswahlliste. NPR-25165: Hotfix für CQ-4248948
...
* Bei Verwendung der vorkonfigurierten Target-Integration wird beim Targeting einer Komponente die ganze Seite anstelle einer leeren, zielgerichteten Komponente gerendert. NPR-25273: Hotfix für CQ-4248003
...
* Das cq-social-as-provider-Bundle startet nicht mit 3.x-Versionen des Mongo-Treibers. NPR-26271: Hotfix für CQ-4252710
...
* Beim Senden von Daten aus einem adaptiven Formular ist die Kodierung falsch. NPR-25539
...
* Die Variable wird als Datentyp „list“ ausgefüllt, der Subtyp ist „string“, aber es wird der Fehler „Objekt kann nicht erzwungen werden“ angezeigt. NPR-26194: Hotfix für CQ-4252287
...
* Proaktive Hotfixes gegen Cross-Site-Scripting(XSS)-Angriffe. NPR-21893: Hotfix für CQ-4223385
* MSM LiveRelationship: Effektive RolloutConfig ist falsch, wenn sich BlueprintConfig im Stammverzeichnis befindet. NPR-23999: Hotfix für CQ-4243000
...
* Aufgrund zahlreicher Anfragen in der Admin-Suchfunktion gibt es eine hohe CPU-Auslastung. NPR-23588: Hotfix für Granite-21286
...
* Wenn ein Brief über die Standardvorschau angezeigt wird, wird die Layout-Fragmentzuordnung nicht angezeigt. Beim Klicken auf „Vorschau“ wird sie aber korrekt angezeigt. NPR-22993: Hotfix für CQ-4237745
...
* Proaktive Sicherheitskorrekturen in der Foundation-Tabelle, um die Konsistenz des Designs sicherzustellen.
...
* Aktualisierung auf die aktuelle Datei „adobe-reader-extensions-dsc.jar“ für Korrekturen in der Reader-Erweiterung.
* Der Validierungs-Hook wurde angepasst, um `:invalid`-Elemente für die Eingabe der Boost-Nummer zu berücksichtigen.

### Assets {#assets-4}

* EmbedXMP-Daten werden für den Pyramid-TIFF-Generierungsprozess immer auf „aktiv“ gesetzt. NPR-22776: Hotfix für CQ-4234498
* Es können nicht mehrere Standardwerte in Feldern mit mehreren Werten festgelegt werden. NPR-22900: Hotfix für CQ-4239000
* (Dynamic Media) Bei Aktivierung des Kontrollkästchens „Dynamische Ausgabedarstellungen“ liefert die heruntergeladene ZIP-Datei das ursprüngliche TIFF-Bild mit einer Null-Byte-Datei. NPR-22410: Hotfix für CQ-4198471
...
* Das Speichern des Segments mit einem großen Wert (10000000000) setzt die Verstärkung auf 0 und verursacht eine Fehlermeldung. NPR-22524: Hotfix für CQ-4237006
...
* (Firefox) Das Kontrollkästchen für die ausgewählte Persona ist nicht korrekt. NPR-23345
...
* Es werden Asset-Sprachkopien auch dann erstellt, wenn in der Übersetzungskonfiguration „Asset nicht übersetzen“ eingestellt ist. NPR-22540: Hotfix für CQ-4237962
...
* DatePicker unterstützt nicht die manuelle Einstellung externer Typhinweise, die durch ein verborgenes Feld festgelegt werden. Beim Ändern des Typhinweises wird ein Konvertierungsfehler ausgegeben. NPR-23333: Hotfix für Granite-21194
...
* Wenn ein Brief über die Standardvorschau angezeigt wird, wird die Layout-Fragmentzuordnung nicht angezeigt. Beim Klicken auf die Schaltfläche „Vorschau“ wird sie aber korrekt angezeigt. NPR-23335: Hotfix für CQ-4237745
...
* Gespeicherte Cross-Site Scripting(XSS)-Schwachstelle auf der Forms Manager-Registerkarte „Notizen“. NPR-27157: Hotfix für CQ-4255556

#### Encryption-Service {#encryption-service}

* (OSGI) [JEE] Falscher Signaturstatus für PDF mit Anhang bei Validierung mit „PDF-Prozess überprüfen“. NPR-23269, NPR-23737
...
* Benutzende können keine Assets mit Haftungsausschluss und langen Dateinamen herunterladen. NPR-22163: Hotfix für CQ-4235274
* Ein einfaches Anführungszeichen verhindert die Aktualisierung der Metadaten in der Massenansicht und die Benutzeroberfläche ist nicht funktionsfähig, wenn Sie die Eigenschaften eines Assets mithilfe der Schnellaktionen in der Symbolleiste öffnen. NPR-22317, NPR-22353: Hotfix für CQ-4236990, CQ-4236469
* Bei einem Auftrag zur Benachrichtigung über das Ablaufen von Assets werden die abgelaufenen Assets nicht deaktiviert. NPR-22346: Hotfix für CQ-4237188
...
* (IE) Beim erstmaligen Erstellen eines Zeichens im Rich-Text-Feld wird dem Zeichen ein nachgestelltes Leerzeichen hinzugefügt. NPR-22443: Hotfix für CQ-4235343
...
* (Digital Publishing Suite) Sowohl das Veröffentlichungsdatum als auch das Datum auf dem Deckblatt müssen für Folios festgelegt werden, bevor sie in DPS hochgeladen wurden. NPR-22484

### Commerce {#commerce}

* Mehrere Cross-Site-Scripting(XSS)-Schwachstellen im Assistenten zum Erstellen von Commerce-Katalogen. NPR-22344: Hotfix für CQ-4237017
...
* Das Rollout einer Struktur, die in einem Primär verschoben wurde, führt zu einem falschen `cq:moveTarget`. NPR-22373: Hotfix für CQ-4232536
...
* Die Target-Engine (mbox.js, at.js) verwendet keine verwalteten URLs, sondern URLs mit Doppelpunkten, die bei bestimmten Bereitstellungen fehlschlagen können. NPR-22366: Hotfix für CQ-4237854
...
* Workflow Starter kann den TypeHint-Wert „String“ nicht akzeptieren. NPR-22436: Hotfix für CQ-4237855
...
* Dropdown-Platzhalterwert im adaptiven Formular in IE11 und Chrome inkonsistent. NPR-22405: Hotfix für CQ-4227096
...
* (HTML-Arbeitsbereich) Wenn eine Benutzerin oder ein Benutzer eine Aufgabe anfordert, wird die Warteschlangenzählung nur für diese bestimmte Person aktualisiert. Dies gilt allerdings nicht, wenn die Seite aktualisiert wird. NPR-19778: Hotfix für CQ-4233665
...
* (Safari) Benutzende können nicht alle Assets im Bedienfeld „Asset-Suche“ anzeigen. NPR-21981: Hotfix für CQ-4213720
* Timewarp gibt den Fehler „RecursionTooDeepException“ mit fehlerhafter Seite zurück und es wird selbst bei Änderung des Datums keine neue Version erstellt. NPR-21707: Hotfix für CQ-4199536
...
* Leistungsprobleme bei der Benutzersynchronisierung, wenn die Anzahl der Benutzenden oder Gruppen groß ist. NPR-20431: Hotfix für CQ-4223282
* Benutzende können bei der Benutzersynchronisierung mit Sling Distribution nicht synchronisiert werden. NPR-21911: Hotfix für Granite-20404
...
* Die jcr-Eigenschaft fehlt für die Initiator-Benutzer-ID beim Erstellen eines Übersetzungsprojekts. NPR-21715: Hotfix für CQ-4230713
...
* Werte, die in der zweiten Option in einem Mehrwert-Feld im Metadatenschema angegeben sind, werden nicht an die zuvor angegebenen Werte in CRX-de angehängt. NPR-21220: Hotfix für CQ-4224526
...
* Beim Hinzufügen eines Target-Frameworks ist der Targeting-Modus nicht in der Liste „Modus auswählen“ im Editor verfügbar. NPR-21047
...
* Der Prozess zum Zurücksetzen der Live Copy wird nach dem Löschen der ersten lokalen Seite in der LC beendet. NPR-21276: Hotfix für CQ-4229743

### Plattform {#platform-5}

* Benutzerdefinierte Taglibs, die als Skript implementierte Referenz-Tags enthalten, werden nach dem Upgrade auf AEM 6.3 nicht gefunden. NPR-20149: Hotfix für Granite-18433
...
* Die Auswahlkomponente löscht die Zieleigenschaft während der Formularübermittlung nicht. NPR-21163: Hotfix für GRANITE-14125
* „HTTP.encodePathOfURI expand double“ kodiert das Pluszeichen (+). NPR-21417: Hotfix für GRANITE-16340
...
* Bei Auswahl des Asset-Verknüpfungstyps wird das Fenster „Asset-Wähler“ im Assistenten zum Bearbeiten der Briefdatenbindung nicht geöffnet. NPR-21164: Hotfix für CQ-4194567
...
* Beim Upgrade auf das neueste Java™ 8-Update 131 wird folgende Ausnahme ausgelöst: „JsafeJCE-Provider ist deaktiviert, eine nach FIPS 140 erforderliche Selbstintegritätsprüfung ist fehlgeschlagen“. NPR-21355
...
* Die Jsafe Jars wurden auf CryptoJ 6.1.3.1 in Core, Encryption, Signature &amp; Document Security aktualisiert. NPR-21360, NPR-21361, NPR-21356, NPR-21358
...
* Die Jsafe Jars wurden auf CryptoJ 6.1.3.1 in RE aktualisiert. NPR-21357
...
* Überprüfungsoption in Package Manager zum Erkennen von ACL-Berechtigungen.
...
* Korrekturen in Sightly-Komponente und Live Copies.
...
* Benutzende können keine Assets mit Haftungsausschluss und langen Dateinamen herunterladen. NPR-20255: Hotfix für CQ-4222139
...
* Der Metadaten-Editor für Inhaltsfragmente verhindert, dass Inhaltsautorinnen und Inhaltsautoren Änderungen an Inhaltsfragmenten speichern können. NPR-20641: Hotfix für CQ-4224755
...
* Die Sightly-Bildkomponente „link to“ erzeugt 403-Fehler aufgrund einer fehlenden .html-Erweiterung. NPR-20823: Hotfix für CQ-4195909
...
* Upgrade auf Apache Commons Email 1.5 mit einer vereinfachten API für den E-Mail-Versand. NPR-20509: Hotfix für Granite-18240
...
* docConvertor kann kein PDF/A erzeugen und gibt den Fehler „Das Präfix ‚stEvt‘ für das Element `stEvt:action` ist nicht gebunden“ aus. NPR-21032: Hotfix für CQ-4222540
* Beim Aufrufen des Dienstes „OMPFSubmission/PDFA/PDFtoPDFA“ wird eine Ausnahme mit dem Namen `java.lang.IllegalArgumentException message:No enum constant com.adobe.internal.pdfm.docbuilder.signature.PathValidationFailureReason.SIGNED_IN_FUTURE` ausgelöst. Diese Ausnahme sorgt dafür, dass der kurzlebige Signaturüberprüfungsprozess erst dann abgeschlossen wird, wenn der Server neu gestartet wurde. NPR-20792
...
* Der Datenvorbereitungsprozess wird mehrmals aufgerufen, wenn das Formular für Mobilgeräte mit dataref-Parametern gerendert wird. NPR-19801: Hotfix für CQ-4230427: CQ-4230400
...
* Miniatur-Assets mit Sonderzeichen im Titel zeigen ein Java™-Objekt im Alt-Attribut an. NPR-20347: Hotfix für CQ-4223620
...
* Mit der Thread Dump Collector-Standardkonfiguration (Standard-AEM-Start) werden keine Thread-Sicherheitskopie gemäß der Zeitplanung generiert. NPR-20288: Hotfix für GRANITE-19488/GRANITE-12741 CQ-90647.
...
* (Touch-optimierte Benutzeroberfläche) Das Löschen von Launches über die Konsole der klassischen Benutzeroberfläche führt dazu, dass keine Seite mehr bearbeitbar ist. NPR-20520: Hotfix für CQ-4225074
...
* Beim Zugriff über eine anonyme Sitzung leitet das ClientLibraryProxyServlet keine Proxy-Anfragen an Client-Bibliotheken in der Veröffentlichungsinstanz weiter und gibt den HTTP 404-Fehler „Nicht gefunden“ aus. NPR-20195: Hotfix für Granite-14409

### Integration {#integration-10}

* Wenn Sie Adobe Target als Ziel-Engine auswählen, wird die Komponente nicht geladen und ein Fehler im Server-Protokoll ausgegeben. NPR-20058: Hotfix für CQ-88071, CQ-109698, CQ-4201600
...
* Das valueCommit-Skript wird für Dropdown-Listen zweimal ausgeführt, wenn es über die Benutzeroberfläche geändert wird. NPR-19989: Hotfix für CQ-110212
...
* Ein vorausgefülltes Formular funktioniert nicht, wenn das Formular für Mobilgeräte für die Ansicht als PDF konfiguriert ist. NPR-20566

**Rights Management**

* Das Dialogfeld zur Auswahl von CAC-Zertifikaten/Zertifikaten zur gegenseitigen Authentifizierung sollte Zertifikate mit erweiterter Schlüsselverwendung (Enhanced Key Usage, EKU) für die Client-Authentifizierung oder Smart-Card-Anmeldung anzeigen. NPR-20708
...
* Fehlerbehebungen für den unabhängigen Persistenz-Cache für ContextHub.
...
Im Zuge dessen ist eine neue Dynamic Media-Funktionalität verfügbar, die eine Verbindung zur neuen Dynamic Media-Veröffentlichungsinfrastruktur für eine schnellere und skalierbarere Replikation herstellt.
...
* AEM weist ein unerwartetes Verhalten auf, wenn eine Benutzerin oder ein Benutzer versucht, eine Version einer von einer anderen Person gesperrten Seite zu veröffentlichen `/unpublish/create`. NPR-19249; Hotfix für CQ-4215298 und CQ-4203856
* Beim manuellen Bewerben eines verschachtelten Launches wird die untergeordnete Seite gelöscht. NPR-19704
* Persistenzprobleme, wenn ContextHub-Speicher während der Initialisierung die standardmäßige Persistenzschicht überschreiben. NPR-19979: Hotfix für CQ-4218399
...
* Adaptive Formulare wurden verbessert, um PDF als Anlagen in Safari anzuhängen. Um die gleiche Funktion in bestehenden Formularen zu unterstützen, ändern Sie die Konfiguration im Anhangs-Widget und aktualisieren Sie unter „Unterstützte Dateitypen“ den Wert „application/pdf“ anstelle von „.pdf“. NPR-19623
...
* Senden-Schaltfläche beim Klicken deaktiviert, um zu verhindern, dass mehrere Formulare auf einer Übersetzungsseite übermittelt werden.
...
* Probleme beim Anwenden des OmniSearch-Filters auf Smart-Sammlungen im Safari-Browser. NPR-19511
...
* Der Workflow-Benachrichtigungsdienst kodiert die Links in einer E-Mail nicht, wodurch verhindert wird, dass sie geladen werden, wenn Benutzende darauf klicken. NPR-19490: Hotfix für CQ-4218055
* Die vollständige Liste der Seiten/Assets kann mit Chrome nicht in der Spaltenansicht geladen werden. NPR-19458: Hotfix für CQ-4214248
* Beim Aktivieren des Workflows für Aktivierungsanfragen wird im AEM-Posteingang ein falsches Symbol für die Ausschaltzeit angezeigt. NPR-19365: CQ-4216174
* Probleme mit der Sortierung in der Listenansicht. NPR-19217: CQ-95602
* Beim Ändern des Titels oder des Miniaturbilds in den Einstellungen für den Asset-Ordner werden die ursprüngliche Gruppe und die ursprünglichen Berechtigungen des Ordners überschrieben. NPR-19283: Hotfix für CQ-4216080
...
* Probleme bei mehreren RTE-Komponenten in einem Dialogfeld. NPR-19311: NPR-19587
...
* Projektbearbeitende können keine Assets in den Asset-Ordner des Projekts kopieren/einfügen. NPR-19619
...
* Langsames Rendern von Miniaturen aufgrund von Artikeln in voller Größe in der AEM-Artikelkonsole. NPR-19086: CQ-4217148
...
* Das Dialogfeld „Targeting“ wird nicht im Targeting-Modus angezeigt, wenn ein Zielmodul mehr als einmal bearbeitet und gespeichert wird. NPR-19144: Hotfix für CQ-4216708

### Workflow {#workflow-2}

* Benutzende können in der klassischen Benutzeroberfläche Benachrichtigungen im Posteingang nicht nach Person/Gruppe filtern. NPR-19122: Hotfix für CQ-4215374
...
>* Die Suche funktioniert nicht bei dynamischen Inhalten (wie Datenwörterbuchelement- oder Variablenwerten) im Dokumentfragment.
...
* Die Dienste des AEM Forms Manager-Kern-Bundles werden beim Neustart des Servers nicht gestartet. Hotfix für CQ-4217014

### JEE-Installationsprogramm von Forms {#forms-jee-installer-12}

#### Installieren von LCM {#install-lcm-2}

* Der Administratorbildschirm unter Microsoft® Windows zeigt nach der Installation von CFP6 die Versionsnummer 6.0 an. Hotfix für CQ-4217573
...
* Verhaltensänderung bei der Anzeige von Titeln auf der Bildkarte für das Bild, für das die dc:title-Eigenschaft auf „String“ (Mehrfachfeld) eingestellt ist.
* Fehlerbehebungen für Leistungsprobleme mit Cloud-Services für dynamische Medien, der Touch-optimierten Benutzeroberfläche und der Sicherheitsbenutzeroberfläche.
...
* Die Aktionsschaltflächen zum Veröffentlichen sind auch dann sichtbar, wenn Benutzende nicht über Replikationszugriff verfügen. NPR-17353; Hotfix für CQ-4209269
...
* Durch das Anwenden von Berechtigungen für DM-Makros wird die Ansicht für Admin-Benutzende unterbrochen. NPR-18544; Hotfix für CQ-4211729
* Durch „Später veröffentlichen“ für Assets wird eine ungültige ArgumentException ausgelöst. CQ-4214532

### Sites {#sites-12}

* In einem Aktiv-Aktiv-Autoren-Cluster mit MongoDB versuchen beide Autorinnen bzw. Autoren, die Replikation für denselben Inhalt auszulösen, wenn die Zeit die für den Inhalt eingestellte Einschaltzeit erreicht. NPR-18708; Hotfix für CQ-4210982
...
* Das JCR-Installationsprogramm aktualisiert nach der Paketinstallation nicht die Bundle-Version. NPR-18728; Hotfix für NPR-15135
* Binärlose Replikation (BLR) schlägt bei Binärdateien zwischen Autoren- und Veröffentlichungsumgebung fehl. NPR-18704
* Apache Felix HTTP Bridge-Auflösungsanfrage in einer AEM-Umgebung. NPR-18297
...
>
>* Beim Kopieren und Einfügen aus Word/Web in den CM-Texteditor wird Inhalt mit Zeilenumbruch angezeigt. NPR-19530
>* Der Inhalt ohne Zeilenumbruch wird im CM-Texteditor nicht umgebrochen. NPR-19449
>

#### Adaptive Formulare {#adaptive-forms-9}

* Beim Hinzufügen eines Bedienfelds für wiederholbare Bedienfelder wird der Wert des Dropdown-Felds im vorherigen Bedienfeld gelöscht. NPR-18772
...
* Ein Skript zum Ändern des Schaltflächentitels beim Initialisieren des Stammbedienfelds (guideRootPanel) funktioniert nicht. NPR-18476
* Die Bildlaufleiste wird für im Regeleditor erstellte Regeln nicht im rechten Bedienfeld angezeigt. NPR-18716
...
* Eine Kundin oder ein Kunde wird blockiert, wenn eine Person ohne die erforderliche Berechtigung versucht, den Vorgang für ein Asset zu verschieben. NPR-18330; Hotfix für CQ-4212560
...
* Eine Miniatur für die PDF wird nicht generiert. NPR-17831, NPR-17750; Hotfix für CQ-4210547
* Bei einem Auftrag zur Adobe CQ DAM-Ablaufbenachrichtigung werden abgelaufene Assets nicht deaktiviert. NPR-17666; Hotfix für CQ-107766
...
* Die Anmeldung schlägt aufgrund einer NumberFormatException fehl, wenn die historyShow-Eigenschaft aktiviert ist. NPR-18073; Hotfix für CQ-101965
...
* Steuerelemente der Touch-optimierten Benutzeroberfläche werden für Benutzende, die über die erforderlichen Berechtigungen verfügen, ausgeblendet. NPR-17945; Hotfix für CQ-4211231
...
* Abfragen werden durchlaufen, wenn für einen Katalog-Blueprint keine Bedingungen für einen Abschnitt definiert sind. NPR-18229; Hotfix für CQ-4211924
...
* Das Kontrollkästchen zur Wiederherstellung der Vererbung fehlt. NPR-17753; Hotfix-Anfrage für GRANITE-4210139
...
* Anfrage zur Verwendung einer aktualisierten Version des org.apache.sling.servlets.post-Servlets (2.3.22) in der Apache Sling-API, um einer XSS-Schwachstelle zuvorzukommen. NPR-18963

### Übersetzung {#translation-6}

* Die Übermittlung der Asset-Seite sollte nicht erneut für ein Übersetzungsprojekt erforderlich sein, bis das Projekt abgeschlossen ist. NPR-18249; Hotfix für CQ-4209908
...
* Seiteneigenschaften können nach Änderungen nicht beendet werden. NPR-17832; Hotfix für CQ-96110
...
* Beim Erstellen eines Briefes wird die Beschreibung des Briefes nicht gespeichert. NPR-18039
...
* Unerwartete Fehler in den Protokollen bei der Installation eines Add-on-Pakets. NPR-18295
...
* PDF-Dokumente können nicht mit einem Remote-Hardware-Sicherheitsmodul signiert werden. NPR-18017
...
* Verbesserte Reaktionsfähigkeit der Aktionsleiste beim Anzeigen von Symbolleistenaktionen und Coral-Komponenten.
...
* Beim Verschieben einer Seite mithilfe der klassischen oder der Touch-optimierten Benutzeroberfläche werden im Dialogfeld „Verschieben“ keine Verweise über 150 angezeigt, sodass Benutzende diese Verweise nicht aktualisieren und die Seite nicht erneut veröffentlichen können. Dieses Problem wurde behoben, indem die Eigenschaft „maxRefNo“ für die klassische Benutzeroberfläche eingeführt wurdel, die im folgenden Siteadmin-Knoten konfiguriert werden kann: `'/libs/wcm/core/content/siteadmin'`. Diese Eigenschaft gibt die maximale Anzahl von Verweisen (Standardwert 150) an, die vor einem umfangreichen Verschiebevorgang angezeigt wird. Wenn eine Seite mehrere Verweise enthält, werden diese nicht im Dialogfeld „movePage“ angezeigt. Diese Konfiguration funktioniert auch für „damadmin“ und „miscadmin“, wenn die Konfiguration auf die folgenden Knoten angewendet wird: `'/libs/wcm/core/content/damadmin'` bzw. `'/libs/wcm/core/content/miscadmin'`. NPR-17222; Hotfix für CQ-85878
...
* Benutzende mit der Berechtigung „Schreibgeschützt“ für die AEM Mobile-App können Inhalte von der AEM Mobile-Content-Management-Seite nicht in einer Vorschau anzeigen. NPR-17390; Hotfix für CQ-4209690
...
* Bei einem adaptiven Formular mit Anhang werden doppelte Einträge für die afSubmissionInfo-Tags in den übermittelten XML-Daten erstellt, wenn das Formular zum zweiten Mal übermittelt wird. NPR-17364
...
* Bei einem für AB Testing konfigurierten adaptiven Formular wird der Test durch Klicken auf „AB Testing starten“ nicht gestartet und es wird ein Browser-Konsolenfehler ausgegeben. NPR-17838
...
* Die Verwendung des AEM Forms 6.2-Ausgabe-Service zum Zusammenführen eines bestimmten Formulars mit einer Daten-XML dauert 20-mal länger. Dies wurde nun für Windows- und Linux®-Umgebungen behoben. NPR-17501
...
* Die Funktionen von Formularbenutzenden sollten identisch sein, unabhängig davon, ob die JEE-Admin-Benutzeroberflächenkonsole oder die OSGi-Konsole verwendet wird. NPR-17670
...
* Das Hinzufügen oder Anpassen von Spalten zu bzw. an die **Assets-OmniSearch**-Ergebnisse durch Überlagern in `/apps` funktioniert nicht. NPR-16737: Hotfix für CQ-4206785
...
* Die Anzahl der im Bildschirm „Benutzerverwaltung“ angezeigten Ergebnisse ist in der Karten- und Listenansicht unterschiedlich. NPR-16241; Hotfix für GRANITE-16914
...
* `Camera RAW`-Dateien (einschließlich ARW, CR2, NEF, DNG und EPS), die als Ausgabedarstellung in Assets hinzugefügt wurden, können nicht ausgewählt oder gelöscht werden. Solche Dateien werden automatisch heruntergeladen, wenn Benutzende darauf klicken. NPR-16949: Hotfix für CQ-4206846
* Beim Erstellen einer PDF-Datei in einer anderen PDF-Datei in der Assets-Benutzeroberfläche werden die erstellten PDF-Dateien in der DAM-Benutzeroberfläche nicht angezeigt. Im CRX-Repository sind die PDFs aber sichtbar. NPR-16833: Hotfix für CQ-4206501
...
* Die Launch-Bewerbung in WCM-Launches dauert lange, wenn ein Launch mit einer umfassenden Seitenstruktur beworben werden soll. NPR-16480: Hotfix für CQ-82731
...
* Bei WCM-Launches kann die Veröffentlichung von Seiten, die mit einem Launch verknüpft sind, nicht rückgängig gemacht werden, wenn die Aktion über die Seiteneigenschaften in der Touch-optimierten Benutzeroberfläche initiiert wird. NPR-16560: Hotfix für CQ-4204681
...
* Beim Navigieren zum Bedienfeld **[!UICONTROL Globale Navigation]** ist das Benutzererlebnis in Firefox oder Google Chrome unterschiedlich. Der Firefox-Browser zeigt das Menü **[!UICONTROL Tools]** an. Der Google Chrome-Browser zeigt die das Menü **[!UICONTROL Navigation]** an. NPR-16770; Hotfix für CQ-4200456

### Campaign {#campaign}

* Beim Testen von AEM-Kampagnenvorlagen und Ändern von Testadressen, um „Zusätzliche Daten“ einzuschließen, wird das Adobe Campaign-Dropdown im ContextHub der Touch-optimierten Benutzeroberfläche nicht mehr angezeigt. NPR-16771: Hotfix für CQ-105748

### Mobile On-Demand {#mobile-on-demand-3}

* Beim Preflight einer Publikation aus AEM Author verursacht eine Preflight-Aktion, die länger als 5 Sekunden dauert, einen ungewöhnlichen Anstieg im Splunk-Dashboard „AEMM – AEM PECS-Integration“ mit einer hohen Anzahl von Statusanfragen. NPR-16908: Hotfix für CQ-4207055
...
* Im Regeleditor für adaptive Formulare zeigt **[!UICONTROL Element auswählen]** das Ereignis als „null“ an. NPR-17139
* Das übermittelte Formular wird erneut gesendet, wenn mit dem Vorwärtspfeil (>) vorwärts navigiert wird. NPR-17080
* Beim Übermitteln eines adaptiven Formulars über AJAX wird die Callback-Funktion „error“ im Falle eines Fehlers nie aufgerufen. NPR-17034
...
* Unterstützung für regulären Ausdruck vom Typ `dataRef=C:/Users/`in der **[!UICONTROL standardmäßigen Vorbefüllungsdienstkonfiguration]**. Dieser Typ dient zum Vorbefüllen von Daten für adaptive Formulare. NPR-16425
...
* Die Dropdown-Liste „Schriftart“ füllt nicht die Schriftfamilie beim Erstellen eines Textbausteins, der auf einem Datenwörterbuch unter Verwendung von Internet Explorer basiert. NPR-16944
...
* `Upload Comments` für Dateianhänge werden in der Benutzeroberfläche für übermittelte Instanzen nicht angezeigt, obwohl sie in der im CRX-Repository gespeicherten XML-Datei vorhanden sind. NPR-17075
...
* Während des Upgrade-Prozesses schlägt Configuration Manager mit einer Zeitüberschreitung fehl. NPR-16774 (Siehe [Konfigurieren der Zeitüberschreitung für Vorgänge auf Komponentenebene](install-cfp-aem-forms-jee.md#configuring-timeout-for-operations-at-component-level-npr)).
...
* Fehlerbehebungen bei der Verwendung von Targeting-synchronisierenden Zielgruppen, Veröffentlichung von Kampagnen und Auswahl der Zielmetrik in der Touch-optimierten Benutzeroberfläche.
* Behebt Synchronisationsprobleme bei Übersetzungsvorgängen
* Bietet erhöhte Sicherheit für den Vorbefüllungs-Service von Forms.
* Verbesserungen in der Entwurfs- und Übermittlungskomponente des Formularportals und im Barcode-Formular-Service.
...
* Nach der Aktualisierung von AEM 6.0 auf AEM 6.2 zeigt die klassische Benutzeroberfläche aufgrund zahlreicher Abfragen eine langsame Performance bei der Suche nach Tags. Um das Problem zu beheben, können die unter [Deaktivieren des Replikationsstatus in der Tagging-Konsole (klassische Benutzeroberfläche)](#disable-replication-status-in-tagging-console-classic-ui-npr) beschriebenen Schritte ausgeführt werden. NPR-15842: Hotfix für CQ-4201748.
...
* Der Versuch, eine Seite in eine Seite ohne Unterseiten einzufügen, funktioniert im Sites-Bildschirm der Touch-optimierten Benutzeroberfläche nicht, da die Schaltfläche „Einfügen“ nicht angezeigt wird. NPR-15894: Hotfix für CQ-4201696.
* Beim Blättern durch die Registerkarte „Seiten“ im Bedienfeld „Content Finder“ werden einige Seitensätze in der klassischen Benutzeroberfläche auf unbestimmte Zeit angezeigt, während in der Touch-optimierten Benutzeroberfläche nur wenige sich nicht wiederholende Seiten angezeigt werden. NPR-16271: Hotfix für CQ-4202371
...
* Benutzende können keine Assets hochladen oder Ordner erstellen, während sie durch Assets navigieren, da das Verhalten bei Verwendung der Schaltfläche „Erstellen“ inkonsistent ist. NPR-16410: Hotfix für CQ-4204793
...
* Beim Erstellen einer Target-A/B-Test-Aktivität in AEM synchronisiert sich die Zielgruppe nicht mit Target und es wird „Keine Zielgruppen“ angezeigt. NPR-16229: Hotfix für CQ-4204210
...
* Bei der Verwendung von Targeting wird beim Veröffentlichen der Kampagne nicht automatisch die gesamte Baumstruktur, einschließlich Marke und Primärteil, veröffentlicht. NPR-15855: Hotfix für CQ-94630

### Übersetzung {#translation-8}

* „Übersetzungsauftrag synchronisieren“ wird jetzt automatisch ausgelöst und die AEM-Abfrage erfolgt nun, ohne dass die Übersetzungsprojekte angestoßen werden. NPR-15163: Hotfix für CQ-90856
...
* Beim Speichern eines adaptiven Formulars mit einem Anhang wird der vollständige Pfad des Anhangs im `fileAttachment`-Tag der generierten XML hinzugefügt – und nicht der Name des Anhangs. NPR-16529
...
* Beim Versuch, ein Fragment innerhalb eines Fragments im Formulareditor zu speichern, füllt der Fragmentmodellstamm den Wert des untergeordneten Fragments nicht aus. NPR-15943
...
* Bei Dateianhangs-Widgets, die mehrere Anhänge zulassen, führt die Übermittlung einer neuen Formularinstanz mit einem Anhang in einem Widget, das bereits über einen vorherigen Anhang verfügt, zur Anzeige eines Fehler-Codes. Dieser Fehler tritt beim Öffnen des hinzugefügten Anhangs anstelle des tatsächlichen Inhalts auf. NPR-16258
* Sichern des Formularvorbefüllungs-Service vor unbefugtem Zugriff durch Protokolle wie `file://`, `http://` und `ftp://`. Weitere Informationen finden Sie unter [Konfigurieren des Vorbefüllungsdienstes mithilfe von Configuration Manager](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions). NPR-15414

* Anfrage zum Rendern des adaptiven Formulars im PDF-Format anstelle von HTML im Überprüfungsschritt und Anhängen aller Anhänge an das PDF, damit der Ausdruck das vollständige Formular zeigt. NPR-9011

**Korrespondenzverwaltung**

* Beim Arbeiten mit Textfragmenten in einem Brief im Vorschau- oder Bearbeitungsmodus wird bei der Konvertierung von Text in eine Liste die gesamte Brieffunktionalität abgebrochen und ein JavaScript-Fehler erzeugt. NPR-16460
* Das Importieren einer XSD-Datei zum Erstellen eines Datenwörterbuchs im Correspondence Management-Knoten schlägt fehl, da der Browser jedes Mal nicht mehr reagiert, wenn die XSD-Datei hochgeladen und der Stammknoten ausgewählt wird. Dieses Problem ist Browser-unabhängig und wird nicht in Serverprotokollen angezeigt. NPR-16452
...
* Wenn ein schwebendes Feld als Eingabefeld aus einem XDP-Fragment angezeigt wird, wird das Feld in der Briefvorschau bei Verwendung von Internet Explorer nicht erweitert. NPR-16367
...
* Beim Bearbeiten eines Textdokumentfragments mit Internet Explorer schlägt der Einzug im Dokument fehl, da der Cursor keinen Texteinzug zulässt. NPR-16128
* Das Hinzufügen eines Datenwörterbuchs zu einem vorhandenen Textdokumentfragment oder dessen Änderung nimmt viel Zeit in Anspruch und die Benutzerin bzw. der Benutzer wird nicht immer benachrichtigt. NPR-16102
* Bei der Vorschau eines Briefes mit bildlauffähigem Inhalt mit Internet Explorer überschneidet sich die Bildlaufleiste des Browsers mit der Bildlaufleiste des Briefes. Daher kann für Fragmente auf der rechten Seite nicht der gesamte Inhalt angezeigt werden. NPR-16068
* Beim Erstellen oder Bearbeiten von Textdokumentfragmenten mit Google Chrome wird das Dropdown-Menü zur Farbauswahl automatisch angezeigt und kann nicht entfernt werden. Benutzende müssen „Liste“ als Typ für die Dateneingabe auswählen, damit das Fragment bearbeitet werden kann. NPR-16067
...
* Die Art der Datenverknüpfung in Briefen beim erneuten Authoring wird als „Benutzer“ angezeigt, auch wenn zuvor etwas anderes eingestellt war. NPR-16619
...
* Schützen des Formularvorbefüllungsdienstes vor unbefugtem Zugriff durch Protokolle wie „file://“, „http://“ und „ftp://“. Weitere Informationen finden Sie unter [Konfigurieren des Vorbefüllungsdienstes mithilfe von Configuration Manager](https://experienceleague.adobe.com/de/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions). NPR-15434
...
* Erweitern der Suchfunktionalität während der Briefvorschau in Correspondence Management, um die Suche nach Text im Textfragmentinhalt zu ermöglichen, anstatt nur den Brieftitel oder das Label zu suchen. NPR-16103
...
* Der Wert für Tags mit der Eigenschaft `tagBasePath` wird im Dialogfeld der klassischen Benutzeroberfläche beim Navigieren zu einer Seitenkomponente nicht abgerufen. NPR-15543: Hotfix für CQ-4199950
...
* Eine Benutzerin oder ein Benutzer wählt einen Knoten in CRXDE aus (z. B. `/content/dam/`) und klickt dann auf die Registerkarte „Zugriffssteuerung“, um sicherzustellen, dass eine Zugriffssteuerungsliste vorhanden ist. Beim Ziehen und Ablegen einiger Elemente werden nun die Elemente verschoben, aber nicht das ausgewählte. NPR-15696; Hotfix für GRANITE-16300
...
* Der Änderungsstatus für den Workflow-Posteingang im WCM-Kern ändert sich nicht, wenn eine Benutzerin oder ein Benutzer eine Seite nach der Aktivierung eines Workflows ändert. NPR-15684: Hotfix für CQ-4196974
* Das Anker-Plug-in im Rich-Text-Editor für die Touch-optimierte Benutzeroberfläche generiert nicht konformes HTML5, wenn Benutzende auf das Ankersymbol klicken und einen Namen hinzufügen. Es sollte ein id-Attribut anstelle eines name-Attributs im HTML5-Tag für das Ankerelement hinzufügen. NPR-15650: Hotfix für CQ-89782
...
* Wenn in der Benutzeroberfläche des Inhaltsfragment-Editors Varianten eines Inhaltsfragments erstellt werden, zeigt das Seitenbedienfeld nicht die Bildlaufleiste an, um durch alle Varianten zu navigieren. NPR-15445: Hotfix für CQ-4199444
...
* Bei einer Site, die Live Copies verwendet, zeigt die Aktivierung des Kontrollkästchens „Live Copy“ im Bereich „Spalten“ in der Siteadmin-Konsole den Status „Live Copy“ nicht korrekt an und es wird nur HTML-Markup angezeigt. NPR-15108: Hotfix für CQ-97086
...
* Wenn Sie die Seite „Bearbeiten“ im Timewarp-Modus schließen und versuchen, sie erneut über die Siteadmin-Ergebnisse zu öffnen, wird ein Fehler mit dem Status `500` angezeigt. NPR-14965: Hotfix für CQ-109647:
...
* Wenn nach der Suche nach einem Asset in OmniSearch ein Asset ausgewählt wird und die Eigenschaften bearbeitet werden, indem auf **Eigenschaften anzeigen** und dann auf **Speichern** geklickt wird, werden die Benutzenden auf eine leere Seite umgeleitet. NPR-15900: Hotfix für CQ-4202372
...
* Beim Veröffentlichen eines Assets aus der Kartenansicht wird die Karte nicht aktualisiert, um den veröffentlichten Status wiederzugeben. Stattdessen wird die Seite aktualisiert. NPR-15826: Hotfix für CQ-102732
...
* Wenn Benutzende beim Navigieren in Assets und Verwenden des Anzeigemodus „Spaltenansicht“ die Ansicht aktualisieren, nachdem sie ein Asset ausgewählt und darauf geklickt haben, werden die Asset-Details anstelle des aktualisierten Inhalts angezeigt. NPR-15768: Hotfix für CQ-4201727
...
* Beim Zugriff auf die Benutzeroberfläche „Meine Link-Freigaben“ mit Firefox werden die freigegebenen Elemente oder Benutzenden nicht angezeigt und der Bildschirm ist unbrauchbar. NPR-15539: Hotfix für CQ-4200992
* Wenn bei Verwendung von Digital Asset Manager eine Seite einer Reihe von Bildern zugeordnet ist, wird durch das Verschieben der Bilder in einen neuen Ordner die Seitenzuordnung unterbrochen. Daher fehlen auf der zugeordneten Seite einige der Bilder. NPR-15538: Hotfix für CQ-111479
...
* Bei Verwendung der Konsole „Asset-Suche“ in der Spaltenansicht schlägt der Versuch, einen Ordner zu erstellen, einmal fehl. Ein erneuter Versuch ist dann aber erfolgreich. NPR-15370: Hotfix für CQ-4199448
* Wenn ein in der DAM-Benutzeroberfläche ausgewähltes Asset oder ausgewählter Ordner ein Komma im Namen enthält, ist die Registerkarte „Verweise“ nicht verfügbar und zeigt die Meldung „Liste der Verweise ist für Mehrfachauswahl nicht verfügbar“ an. NPR-15362: Hotfix für CQ-4199721
...
* In der **[!UICONTROL Touch-optimierten Benutzeroberfläche]** wird das gespeicherte Datum für Datumsfelder angezeigt, die nun bei Verwendung der Internet Chrome-Browser-Version 56.0.2924.87 type=&#39;datetime&#39; aufweisen. NPR-15383: Hotfix für GRANITE-16481
...
* Mit OmniSearch können Kundinnen und Kunden, die `/apps` verwenden, keine Spaltendatenquelle hinzufügen, da davon ausgegangen wird, dass die Standortkonfiguration unter */libs/granite/omnisearch/content/metadata/* aufgeführt ist. NPR-13188; Hotfix für GRANITE-16479
...
* Die Ausführung des Scene7-Workflows führt zu geöffneten Dateien, die nicht geschlossen werden. Anfrage zur Verbesserung des AEM-S7-Dienstes, damit eine einzelne HttpClient-Instanz mit einer freigegebenen Pooling-Konfiguration beibehalten und wiederverwendet wird. NPR-15357: Hotfix für CQ-109958
...
* Bei Verwendung der Komponenten „Campaign – Targeting“ und „`MAC` – Test- und Target-Integration“ wird nach dem Aufheben der Veröffentlichung von Aktivitäten der Aktivitätsstatus in der primären Benutzeroberfläche nicht aktualisiert. NPR-15401: Hotfix für CQ-4199839
...
* Der `afData/afBoundData`-Wrapper ist in der übermittelten XML vorhanden, auch wenn die XML zum Vorausfüllen keinen `afData/afBoundData`-Wrapper in XML-schemabasierten adaptiven Formularen aufweist. NPR-15541
...
* Der Vorbefüllungsdienst funktioniert nicht bei XDP-Formularen. NPR-15466
* Beim Speichern von Entwürfen und Übermittlungen adaptiver Formulare in die Datenbank wird der Status des adaptiven Formulars beschädigt, wenn die Datenbankverbindung aus irgendeinem Grund fehlschlägt (z. B. nach langer Inaktivität). NPR-15297
...
* Bei Verwendung des Ausgabe-Service zum Zusammenführen eines bestimmten Formulars mit dataxml beträgt die Antwortzeit das 20-Fache der Zeit, die der ES4 SP1-Server benötigt. NPR-15283
...
* Benutzende können sich nicht bei der AEM Forms-App anmelden. NPR-15891
...
* Die XSS-Schutzprüfung verursacht eine falsche Kodierung in der Sightly-Komponente. NPR-14004: Hotfix für CQ-93821
* Anfrage zum Upgrade von Jackrabbit File Vault auf 3.1.30, um mehrere Probleme zu lösen. NPR-13454
* Es tritt ein Cache-Fehler auf, wenn bei der Sling-Verteilung die autorenseitigen Verteilungspakete mit der Veröffentlichung synchronisiert werden. NPR-13034: Hotfix für GRANITE-13970
...
* Die standardmäßig vorkonfigurierte Videokomponente rendert nicht die Videominiatur. NPR-14976
* Informationen werden im Vorlageneditor langsam auf der Registerkarte für Live-Nutzungen geladen. NPR-14880: Hotfix für CQ-83417
...
* Beim Übermitteln des PageProperties-Dialogfelds aus dem Editor werden unveränderte Daten auf den LiveCopy-Registerkarten neu geschrieben. NPR-14693
* Wenn das PageProperties-Dialogfeld vom Editor aus übermittelt wird, schreibt der MSM-Postprozessor einige Parameter aus der Anfrage anstelle des `msm:writeLiveCopyConfig`-Parameters. NPR-14434
...
* Assets mit dem Ausdruck „Mit Bedingung wiederholen“ werden nicht richtig angezeigt. Wenn die Benutzerin bzw. der Benutzer eine Vorschau der `*CDN3835RLCEN*`-Briefvorlage anzeigt, werden keine Assets angezeigt, die sich im Hauptzielbereich befinden. Bei Dateianhangs-Widgets, die mehrere Anhänge zulassen, führt die Übermittlung einer neuen Formularinstanz mit einem Anhang in einem Widget, das bereits über einen vorherigen Anhang verfügt, zur Anzeige eines Fehler-Codes. NPR-14844
...
* Asset-Suchabfragen werden bei gleichzeitiger Suche durch mehrere Benutzende langsam in der Touch-optimierten Benutzeroberfläche ausgeführt. NPR-15019: Hotfix für CQ-4195405
...
* Benutzende können eine gespeicherte Suche oder eine Smart-Sammlung nicht löschen. NPR-14924: Hotfix für CQ-108494
...
* Benutzende ohne Replikationsrechte können nun Asset-Ordner löschen. NPR-14321: Hotfix für CQ-88271
* Beim Versuch, die Videoprofile für ein Video im Kanaleditor zu bearbeiten, wird das Dialogfeld „Design“ nicht geöffnet und eine Null-Zeiger-Ausnahme im Fehlerprotokoll ausgelöst. NPR-14144: Hotfix für CQ-81101
...
* Benutzende können Metadaten für Assets nicht massenhaft auf der Eigenschaftenseite bearbeiten. NPR-13721: Hotfix für CQ-100703
...
* Benutzende der AMS AEM Assets-Autoreninstanz, die von verschiedenen Netzwerken aus zugreifen, können keine Assets per Chunkupload hochladen, sofern sie nicht über eine Löschberechtigung für Ordner verfügen. NPR-12768: Hotfix für CQ-82715
...
* Seit dem `Jquery`-Update können Benutzende nicht mehr eine Asset-Sammlung auswählen und die Auswahl im Bedienfeld „Inhalt verknüpfen“ eines Inhaltsfragments bestätigen. NPR-14847: Backport für CQ-4194209
...
* Beim Exportieren eines Übersetzungsprojekts, das durch menschliche Übersetzung und ohne einen Übersetzungsanbieter erstellt wurde, wird keine Datei „translation_export_summary.xml“ generiert, da die GUID-Zuordnungsdatei fehlt. NPR-13137: Hotfix für CQ-91976
...
* Beim Klicken auf den Payload-Link auf der Registerkarte „Archiv“ der Workflow-Konsole wird ein Fehler mit dem Antwort-Code „404“ zurückgegeben. NPR-14993: Hotfix für CQ-4194977
...
* Benutzende können beim Initiieren von Workflows keine Vorschau der Payload in der Konsole „Workflow-Posteingang“ anzeigen. NPR-13226: Hotfix für CQ-100275
* Das mit dem SAML-Authentifizierungs-Handler konfigurierte Cookie „saml_request_path“ zeigt das Cookie mit einem zusätzlichen `?`. Wenn eine SAML-Antwort an AEM zurückgesendet wird, gibt das AEM-Cookie „saml_request_path“ aufgrund bereits codierter Zeichen einen ungültigen Wert zurück. NPR-13517: Proaktiver Hotfix für GRANITE-11722 und GRANITE-14414
...
* Wenn Sie einen Standardwert für ein Optionsfeld festlegen und beim Speichern oder Übermitteln einen anderen Wert auswählen, wird der ausgewählte Wert in der Vorbefüllung nicht angezeigt. NPR-15304
* Google Chrome zeigt ein falsches Verhalten bei Verwendung des Optionsereignisses zum dynamischen Auffüllen der Dropdown-Liste und zum Übermitteln des Wertes des ausgewählten Elements. NPR-15198
...
* Bei Verwendung des Bearbeitungsmodus für adaptive Formulare treten JavaScript-Fehler auf, z. B. „Handler der Komponente ist ungültig“ und „Guidelib ist nicht definiert“. NPR-15112
...
* Das Bedienfeld „Datenelemente“ im Ausdrucksgenerator-Dienstprogramm wird immer weiter geladen, wenn ein Bedingungsmodul erstellt wird, ohne ein Datenwörterbuch auszuwählen. NPR-14688
...
* Beim Navigieren im Verzeichnis *FormsandDocuments* wird die Schaltfläche „Einfügen“ nicht angezeigt, wenn Benutzende ein Asset kopieren und dann zu einem anderen Ordner navigieren. CQ-111327
...
* Wenn eine weitergeleitete Entwurfsaufgabe im HTML-Arbeitsbereich an die Ausgangsbenutzerin oder den Ausgangsbenutzer zurückgegeben wird, wird die Aufgabe nicht in der Warteschlange der Ausgangsbenutzerin oder des Ausgangsbenutzers angezeigt. NPR-15178
...
* Forms Designer stürzt ab, wenn Benutzende das Dienstprogramm zur Rechtschreibprüfung mit dem ausgewählten Formulargebietsschema „Französisch (Kanada)“ ausführen. NPR-13740
...
* Wenn ein adaptives Formular aus einer XDP-Datei erstellt wird, folgt die Tabulatorreihenfolge zur barrierefreien Navigation keinem festgelegten Muster. NPR-12562
...
* Bei einer Cluster-Bereitstellung mit RDBMK oder MongoDB kann das CFP-Paket in einer der Autoreninstanzen installiert werden, die Package Manager verwenden.

* Stellen Sie vor der Cumulative Fix Pack-Installation sicher, dass Sie eine Momentaufnahme oder ein Backup Ihrer AEM-Instanz erstellen.
...
* Überlagern Sie */libs/cq/tagging/widgets/source/widgets/admin/TagAdmin.js* unter *`/apps`*.
...
>[!NOTE]
>
>Diese Konfigurationseinstellungen gelten für AEM Forms-Kundschaft, die Document Security verwendet.

NPR-21355 ist in CFP 12.1 enthalten. Wenn Sie CFP12.1 oder höher installieren, führen Sie das folgende Verfahren aus, um NPR-21355 auf dem JBoss®-Anwendungs-Server zu konfigurieren. Wenn Sie CFP12.1 auf dem AEM Forms-Server installieren, der auf Oracle WebLogic- oder IBM® WebSphere-Programm-Servern ausgeführt wird, ist keine zusätzliche Konfiguration erforderlich:

1. Sichern, löschen und erstellen Sie die Datei „module.xml“. Der Standardspeicherort der Datei ist [AEM_Forms_Installationsverzeichnis]/jboss/modules/system/layers/base/com/adobe/livecycle/main/
...
1. Erstellen Sie ein Backup der Dateien `jsafeFIPS.jar`, `jsafeJCEFIPS.jar` und `certjFIPS.jar` unter [AEM_Forms_Installationsverzeichnis]`/jboss/modules/system/layers/base/com/adobe/livecycle/main/` und löschen Sie die Dateien aus dem zuvor genannten Verzeichnis.
...
Die Anzahl der freigegebenen Warteschlangen wird für andere Benutzende nicht aktualisiert, wenn jemand eine Aufgabe anfordert. Dementsprechend hat Adobe eine neue Eigenschaft eingeführt. Führen Sie die folgenden Schritte aus, um diese Eigenschaft in Ihrer AEM-Instanz zu konfigurieren:
...
1. Fügen Sie in der heruntergeladenen XML-Datei das Tag `<client_tasksPollingInterval>10</client_tasksPollingInterval>` hinzu. Zehn ist der Beispielwert in Sekunden. Sie können ihn entsprechend ändern.
...
* Ein interner Server-Fehler (HTTP 500) tritt auf, wenn die Detailseite der Komponente „Web-Konsole“ geöffnet wird.
* Fehler wie **Cannot create component instance** und **Service factory returned null** treten auf, wenn das Repository neu gestartet wird:
...
* Wenn Sie CFPx auf AEM 6.2 SP1 installieren, das das Feature Pack für Smart-Tag enthält, wird der zuvor hinzugefügte Workflow-Schritt für Smart-Tag-Assets aus dem Workflow „DAM-Update-Asset“ gelöscht.

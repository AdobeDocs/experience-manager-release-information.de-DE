...
* Die Download-Funktionalität verwendet AEM Assets über ein Asset-Download-Servlet, das es anonymen Benutzenden ermöglicht, alle Assets herunterzuladen. NPR-27054: Hotfix für CQ-4254732
...
* Wenn ein Brief über die Standardvorschau angezeigt wird, wird das Layoutfragment-Mapping nicht angezeigt, während es korrekt angezeigt wird, wenn auf die Vorschau geklickt wird. NPR-22993: Hotfix für CQ-4237745
...
* Proaktive Sicherheitskorrekturen in der Foundation-Tabelle, um die Konsistenz des Designs zu gewährleisten.
...
* EmbedXMP-Daten werden für den TIFF- und Pyramid-Generierungsprozess immer auf „aktiv“ gesetzt. NPR-22776: Hotfix für CQ-4234498
...
* Wenn ein Brief über die Standardvorschau angezeigt wird, wird das Layoutfragment-Mapping nicht angezeigt, während es korrekt angezeigt wird, wenn auf die Vorschau geklickt wird. NPR-23335: Hotfix für CQ-4237745
...
* Ein einfaches Anführungszeichen verhindert die Aktualisierung der Metadaten in der Massenansicht und die Benutzeroberfläche ist nicht funktionsfähig, wenn Sie die Eigenschaften eines Assets mithilfe der Aktionen in der Symbolleiste öffnen. NPR-22317, NPR-22353: Hotfix für CQ-4236990, CQ-4236469
...
* Timewarp gibt den Fehler „RecursionTooDeepException“ mit verstümmelter Seite zurück und es wird keine neue Version erstellt, selbst wenn das Datum geändert wird. NPR-21707: Hotfix für CQ-4199536
...
* Beim Aufrufen des Dienstes „OMPFSubmission/PDFA/PDFtoPDFA“ wird eine Ausnahme mit dem Namen `java.lang.IllegalArgumentException message:No enum constant com.adobe.internal.pdfm.docbuilder.signature.PathValidationFailureReason.SIGNED_IN_FUTURE` ausgelöst. Dies verhindert, dass der kurze Signaturüberprüfungsprozess abgeschlossen wird, bis der Server neu gestartet wird. NPR-20792
...
* (Touch-optimierte Benutzeroberfläche) Das Löschen von Launches über die Konsole der klassischen Benutzeroberfläche macht alle Seiten nicht bearbeitbar. NPR-20520: Hotfix für CQ-4225074
...
* Beim Zugriff über eine anonyme Sitzung leitet das ClientLibraryProxyServlet keine Proxy-Anfragen an Client-Bibliotheken in der Veröffentlichungsinstanz weiter und gibt den Fehler „HTTP 404 nicht gefunden“ aus. NPR-20195: Hotfix für Granite-14409
...
* Adaptive Formulare wurden verbessert, um PDF als Anlagen in Safari anzuhängen. Um die gleiche Funktion in bestehenden Formularen zu unterstützen, ändern Sie die Konfiguration im Anlagen-Widget und aktualisieren Sie unter „Unterstützte Dateitypen“ den Wert „application/pdf“ anstelle von „.pdf“. NPR-19623
...
* Der Adminbildschirm auf Microsoft® Windows zeigt nach der Installation von CFP6 die Versionsnummer 6.0 an. Hotfix für CQ-4217573
...
>* Der Inhalt ohne Zeilenumbruch wird im CM-Text-Editor nicht umgebrochen. NPR-19449
>
...
* Das Skript zum Ändern des Schaltflächentitels beim Initialisieren des Bedienfelds „guide root“ funktioniert nicht. NPR-18476
...
* Beim Preflight einer Publikation aus der AEM-Autorenumgebung verursacht eine Preflight-Aktion, die länger als 5 Sekunden dauert, einen ungewöhnlichen Anstieg im Splunk-Dashboard „AEMM – AEM PECS-Integration“ mit einer hohen Anzahl von Statusanforderungen pro Sekunde. NPR-16908: Hotfix für CQ-4207055
...
* Bei der Verwendung von Targeting wird beim Veröffentlichen der Kampagne nicht automatisch der gesamte Baum, einschließlich Marke und Primär, veröffentlicht. NPR-15855: Hotfix für CQ-94630
...
* Bei Widgets mit Dateianhängen, bei denen mehrere Anhänge zulässig sind, wird ein Fehler-Code angezeigt, wenn eine neue Formularinstanz mit einem Anhang an ein Widget gesendet wird, das bereits über einen Anhang verfügt. Dieser Fehler tritt beim Öffnen des hinzugefügten Anhangs anstelle des tatsächlichen Inhalts auf. NPR-16258
...
* Das Hinzufügen eines Datenwörterbuchs zu einem vorhandenen Textdokumentfragment oder dessen Ändern nimmt viel Zeit in Anspruch und die Benutzerin bzw. der Benutzer wird nicht immer benachrichtigt. NPR-16102
* Bei der Vorschau eines Briefes mit bildlauffähigem Inhalt mit dem Internet Explorer-Browser überschneidet sich die Bildlaufleiste des Browsers mit der Bildlaufleiste des Briefes. Daher kann für Fragmente auf der rechten Seite nicht der gesamte Inhalt angezeigt werden. NPR-16068
* Beim Erstellen oder Bearbeiten von Textdokumentfragmenten mit Google Chrome wird das Dropdown-Menü zur Farbauswahl automatisch angezeigt und kann nicht entfernt werden. Die Benutzerin bzw. der Benutzer muss „Liste“ als Typ der Dateneingabe auswählen, damit das Fragment bearbeitet werden kann. NPR-16067
...
* Die Art der Datenverknüpfung in Briefen beim erneuten Authoring wird als „Benutzer“ angezeigt, auch wenn er zuvor anders eingestellt wurde. NPR-16619
...
* Bei Verwendung der Komponenten „Campaign – Targeting“ und „`MAC` – Test- und Target-Integration“ wird durch die Aufhebung der Veröffentlichung von Aktivitäten der Aktivitätsstatus in der primären Benutzeroberfläche nicht aktualisiert. NPR-15401: Hotfix für CQ-4199839
...
* Anfrage zur Aktualisierung von Jackrabbit File Vault auf 3.1.30, um mehrere Probleme zu lösen. NPR-13454
...
* Beim Versuch, die Videoprofile für ein Video im Kanal-Editor zu bearbeiten, wird das Dialogfeld „Entwurf“ nicht geöffnet und eine Null-Zeiger-Ausnahme im Fehlerprotokoll ausgelöst. NPR-14144: Hotfix für CQ-81101
...
* Seit der Aktualisierung von `Jquery` können Benutzende nicht mehr eine Asset-Sammlung auswählen und die Auswahl im Bedienfeld für die Zuordnung von Inhalten eines Inhaltsfragments bestätigen. NPR-14847: Backport für CQ-4194209
...
* Beim Exportieren eines Übersetzungsprojekts, das mit der Übersetzungsmethode als „menschlich“ und dem Übersetzungsanbieter als „keiner“ erstellt wurde, wird keine Datei „translation_export_summary.xml“ generiert, da die GUID-Zuordnungsdatei fehlt. NPR-13137: Hotfix für CQ-91976
...
>[!NOTE]
>
>Die Kundschaft von AEM Forms muss unbedingt beachten, dass das AEM Forms-Add-on-Paket erst nach der Installation jeglicher Service Packs, Cumulative Service Packs oder Feature Packs von AEM installiert werden darf.
...
>[!NOTE]
>
>Diese Konfigurationseinstellungen gelten für AEM Forms-Kundinnen und -Kunden, die die Dokumentensicherheit verwenden.
...
1. Erstellen Sie eine Sicherungskopie der Dateien `jsafeFIPS.jar`, `jsafeJCEFIPS.jar` und `certjFIPS.jar` unter [AEM_Forms_Installation_directory]/jboss/modules/system/layers/base/com/adobe/livecycle/main/ und löschen Sie die Dateien aus dem zuvor genannten Verzeichnis.
...
Die Anzahl der freigegebenen Warteschlangen wird für andere Benutzende standardmäßig nicht aktualisiert, wenn jemand eine Aufgabe beansprucht. Hierfür hat Adobe eine neue Eigenschaft eingeführt. Führen Sie die folgenden Schritte aus, um diese Eigenschaft in Ihrer AEM-Instanz zu konfigurieren:
...
* Ein interner Server-Fehler (HTTP 500) tritt auf, wenn die Detailseite der Web-Konsolen-Komponente geöffnet wird.

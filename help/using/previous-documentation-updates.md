...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>AEM Screens hat AEM 6.4.6 Feature Pack 6 und AEM 6.5.2 Feature Pack 2 veröffentlicht.</p> <p>Weitere Details finden Sie unter <a href="https://experienceleague.adobe.com/de/docs/experience-manager-screens/user-guide/release-notes/release-notes-fp-201909">Versionshinweise für Feature Pack 201909</a>.</p> </td> 
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>Es ist ein <a href="https://experienceleague.adobe.com/de/docs/experience-manager-65/content/assets/administer/aem-pdf-rasterizer" target="_blank">neues Paket verfügbar</a>, das AEM Assets bei der Verarbeitung großer AI-/PDF-Dateien und der Erstellung von Vorschauen und Miniaturansichten unterstützt.<br /> </td> 
  </tr>
  <tr>
   <td>25. Juli 2019</td> 
  ...
  <tr>
   <td>13. Mai 2019</td> 
   <td>IS/IR-API</td> 
   <td>Neue BFC-Werte (Browser-Formatkonvertierung) wurden dem Referenzabschnitt <a href="https://experienceleague.adobe.com/de/docs/dynamic-media-developer-resources/image-serving-api/image-serving-api/attributes/r-bfc">Attribute des Bildkatalogs</a> hinzugefügt.</td> 
  </tr>
  <tr>
   <td>8. Mai 2019</td> 
   <td>Kernkomponenten<br /> </td> 
